...
// cross-state comparison is a group-by instead of an id-guessing exercise
// (lease-clause-decision-log-CA.md §5.40). Regenerated from the 9-state CSV.
//
...
const LANDLORD_EDUCATION = [
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "safe-homes-nondiscrimination",
    bodyText:
  ...
  // Security Deposit
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "nonrefundable-deposit-separate-notice",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "abandoned-property-notice-methods",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "repair-notice-process",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "successor-owner-bound",
    bodyText:
  ...
  // Security Deposit
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "deposit-noncompliance-penalty",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "deposit-cap-interest-account",
    bodyText:
  ...
  // Rent & Payment
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "rent-increase-statute",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "anti-retaliation-statute",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "carbon-monoxide-detector-building-code",
    bodyText:
  ...
  // Rent & Payment
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "rental-fee-transparency-law",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "alt-housing-requirement",
    bodyText:
  ...
  // Security Deposit
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "deposit-nonwaiver-statute",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "security-deposit-noncompliance-penalty",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "security-deposit-successor-owner",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "disclosure-noncompliance",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "habitability-duty-delegation",
    bodyText:
  ...
  // Tenant Responsibilities
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "dv-housing-protections-violation",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "tenant-noncompliance-notice",
    bodyText:
  ...
  // Rent & Payment
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "late-rent-acceptance-waiver",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "late-rent-reservation-fix",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "immigrant-tenant-protection",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "statutory-attorney-fee-actions",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "violent-crime-eviction",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "five-year-lease-exclusion",
    bodyText:
  ...
  // Tenant Responsibilities
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "dv-protections-procedure",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "radon-tenant-disclosure",
    bodyText:
  ...
  },
  {
    ...
    title: "No Move-In Inventory Requirement",
    group: "Disclosures",
    states: ["NE"],
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "move-in-inventory-requirement",
    bodyText:
    ...
    notes: "Confirmed absent — explicitly stated by iPropertyManagement's NE landlord-tenant guide: 'Landlords are not required to document the condition of the rental unit at the start of the lease term.' TITLE NORMALISED 2026-09-19: 'No Move-In Inventory Requirement (Unlike Kansas)' -> 'No Move-In Inventory Requirement'. The old title named ANOTHER state (Kansas) in a Nebraska row's landlord-facing title. The comparison is genuine and kept here: unlike Kansas, Nebraska imposes no move-in inventory duty — but that belongs in the notes, not in a title a Nebraska landlord reads.",
  },
  {
  ...
  // Pets
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "service-animal-fraud-broad-statute",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "alt-housing-self-help",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "tenant-screening-fairness-act",
    bodyText:
  ...
  // Rent & Payment
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "bad-check-restitution-vs-nsf-fee",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "negligence-carveout-flag",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "prohibited-lease-provisions-statute",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "utility-disclosure-attachment",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "attorney-fee-mutuality",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "prohibited-fees-disclosure",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "plain-language-contract",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "security-deposit-pet-cap",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "security-deposit-interest-required",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "limited-retaliation-protection",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "fair-housing-additions",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "housing-voucher-protection",
    bodyText:
  ...
  // Rent & Payment
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "payment-method-fee-ban",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "double-letting-prohibited",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "early-termination-grounds",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "fraudulent-misrepresentation",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    title: "Self-Help Eviction Prohibited",
    group: "Default & Termination",
    states: ["SD"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
  ...
  // Notices & General
  {
    ...
    notes: "SD session 1. SDCL 43-32-27 and 43-32-28. The 180-day rebuttable-presumption window is longer than most states surveyed in this project so far. Triggering events list is close to CO/KS/NE's pattern (code complaint, repair-notice, tenant-organizing) but SD is unusual in also naming rent increases above 'fair market value' and utility-service decreases as retaliatory acts in their own right, not just adverse notices to vacate - worth flagging for the checklist as a broader retaliatory-act definition than most. TITLE NORMALISED 2026-09-19: 'Retaliation Prohibited (South Dakota)' -> 'Retaliation Prohibited' (state name in the title was a per-session convention used only by SD, OH, ND and CO).",
  },
  {
    id: "edu-dv-confidentiality-sd",
    title: "Domestic Abuse Contact Information Confidentiality",
    group: "Notices & General",
    states: ["SD"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    ...
    notes: "SD session 1. SDCL 43-32-19.2. Same confidentiality-obligation pattern already present for CO (edu-dv-confidentiality-co); confirmed as its own distinct code section for SD rather than folded into 19.1. TITLE NORMALISED 2026-09-19: 'Domestic Abuse Contact Information Confidentiality (South Dakota)' -> 'Domestic Abuse Contact Information Confidentiality' (state name in the title was a per-session convention used only by SD, OH, ND and CO).",
  },
  // Access & Entry
  {
  ...
  // Compliance & Prohibited Terms
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "unconscionability-doctrine",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "kaad-accommodation-duty",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "kaad-housing-exemptions",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "smoke-detector-requirements",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "lease-term-limitation",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "habitability-notice-written",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "rental-application-regulation",
    bodyText:
  ...
  // Tenant Responsibilities
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "renters-insurance-restriction",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "environmental-event-termination",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "military-termination-notice",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "fraud-termination-statute",
    bodyText:
  ...
  // Pets
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "assistance-animal-carveout-mismatch",
    bodyText:
  ...
  // Access & Entry
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "ouster-and-entry-remedies",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "periodic-termination-notice",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "servicemember-termination",
    bodyText:
  ...
  // Rent & Payment
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "rent-increase-and-rent-control",
    bodyText:
  ...
  // Notices & General
  {
    ...
    topicKey: "confirmed-absences-misc",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "protected-class-inquiry-record-ban",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "retaliation-protections",
    bodyText:
  ...
  // Pets
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "service-animal-misrepresentation-scope",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "esa-independent-basis",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "ouster-utility-floor-remedies",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "abandoned-property-retake-duty",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "writ-execution-property-duties",
    bodyText:
  ...
  // Compliance & Prohibited Terms
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "dv-information-confidentiality",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "state-servicemember-termination",
    bodyText:
  ...
  // Pets
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "animal-fairhousing-exemption-mismatch",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "radon-rental-disclosure",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "bedbug-mold-disclosure",
    bodyText:
  ...
  // Compliance & Prohibited Terms
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "unconscionability-statute",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "confession-of-judgment-bar",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "holdover-damages-multiplier",
    bodyText:
  ...
  // Security Deposit
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "deposit-cap-statewide",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "deposit-successor-transfer",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "landlord-disclosure-consequences",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "tenancy-at-will-notice",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "renters-insurance-limits",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "double-letting-statute",
    bodyText:
  ...
  // Compliance & Prohibited Terms
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "written-notice-required",
    bodyText:
  ...
  // Pets
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "criminal-penalty-animal-denial",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "post-writ-animal-duty",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "automatic-renewal-notice",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "fair-housing-exemptions",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "dv-state-housing-program-protection",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "disability-modification",
    bodyText:
  ...
  // Disclosures
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "fair-housing-enforcement",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "smoke-alarm-portfolio-exemption",
    bodyText:
  ...
  // Rent & Payment
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "postdated-check-forfeits-remedies",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "alarm-requirements-by-building-type",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "dv-protection-order-chapter-moved",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "disclosure-bar-to-eviction",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "mobile-home-park-eviction-defence",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "state-military-termination",
    bodyText:
  ...
  // Landlord Responsibilities
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "frozen-standard-incorporation",
    bodyText:
  ...
  // Pets
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "exemption-does-not-reach-animal-rules",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["RECOMMENDED"],
    verificationStatus: "VERIFIED",
    topicKey: "statutory-termination-notice",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "tenancy-at-will-termination-notice",
    bodyText:
  ...
  // Compliance & Prohibited Terms
  {
    ...
    title: "Limits on Exculpatory and Indemnity Clauses",
    group: "Compliance & Prohibited Terms",
    states: ["SD"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "exculpatory-clause-limit",
    bodyText:
  ...
  // Disclosures
  {
    ...
    title: "Signed Condition Statement Required at Move-In",
    group: "Disclosures",
    states: ["ND"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "condition-statement",
    bodyText:
  ...
  // Compliance & Prohibited Terms
  {
    ...
    title: "No Penalty Clause Tied to an Eviction",
    group: "Compliance & Prohibited Terms",
    states: ["CO"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
  ...
  // Security Deposit
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "mobile-home-park-carveout",
    bodyText:
  ...
  // Pets
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "service-animal-fraud-penalty",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "mandatory-drug-termination",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "three-day-notice-language",
    bodyText:
  ...
  // Notices & General
  {
    ...
    ruleTypes: ["CONDITIONAL"],
    verificationStatus: "VERIFIED",
    topicKey: "fair-housing-election",
    bodyText:
  ...
  // Rent & Payment
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "bad-check-cure-windows",
    bodyText:
  ...
  // Default & Termination
  {
    ...
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "abandoned-property-safe-harbor",
    bodyText:
  ...
  },
  {
    ...
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "rent-increase-notice-gap",
    bodyText:
  ...
  // Notices & General
  {
    id: "edu-tpa-sunset-ca",
    title: "Tenant Protection Act sunsets January 1, 2030",
    group: "Notices & General",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "tpa-sunset",
    bodyText:
      "Both halves of California's Tenant Protection Act carry an identical sunset: Civil Code sections 1946.2(n) and 1947.12(o) each provide that the section remains in effect only until January 1, 2030, and is repealed as of that date. Both became operative in their current form on April 1, 2024.",
    notes: "CA: Read section-open 2026-09-19. LEGAL-WATCH ITEM, highest priority in CA - on 2030-01-01 the rent cap, the just-cause regime, the mandatory s1946.2(f)(3) lease notice and the s1946.2(e)(8)/s1947.12(d)(5) exemption notice all lapse together unless extended, which would invalidate four CA rows at once. A legislative bill-tracking watch keyed to s1946.2 and s1947.12 should be live well before then. Also note s1947.12(f) requires an LAO report to the Legislature on or before 2030-01-01, which is the likely vehicle for an extension debate.",
  },
  // Disclosures
  {
    id: "edu-no-foreclosure-disclosure-ca",
    title: "No pre-lease notice-of-default disclosure duty (repealed 2018)",
    group: "Disclosures",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California no longer requires a landlord to disclose a recorded notice of default to a prospective tenant before signing a lease. Civil Code section 2924.85 imposed that duty on owners of single-family and 1-4 unit properties from January 1, 2013, but the section repealed itself on January 1, 2018 by its own terms and was not extended. A separate provision, Civil Code section 2924.8, governs notice to tenants after a notice of sale is posted and has not been examined here.",
    notes: "CA: CONFIRMED ABSENT 2026-09-19, and the evidentiary basis is a repeal annotation plus the enacting act's own title ('An act to add AND REPEAL Section 2924.85', SB 1191, Stats. 2012 ch. 566) and the sunset in s2924.85(g) - not a full-text read of the current code index, so this is one notch below the project's CITED standard. Confirm against the current Civil Code index at sync. This row exists because the dormant lease clause foreclosure-disclosure-ca asserted the repealed duty as live; per the proof-of-absence standard a confirmed absence needs its own row or no future canvass can see it. s2924.8 remains OPEN and unread. EVIDENCE UPGRADED 2026-09-19: the SB 1191 enrolled and chaptered text on leginfo (primary) shows s2924.85(g) sunset the section on 2018-01-01 'unless a later enacted statute, that is enacted BEFORE January 1, 2018, deletes or extends that date'. THAT EXTENSION WINDOW CLOSED eight years ago - any revival now would require a fresh enactment adding a new s2924.85, and none was found. The Senate floor analysis confirms the sunset. Justia's latest published version is 2016. Strong enough to treat as confirmed; the one thing not done is viewing the current Civil Code index directly, which leginfo's robots block prevents. NOTE: a December 2025 law-firm article still describes s2924.85 as current law - another live secondary-source error. s2924.8 READ 2026-09-19 - AND IT IS NOT A LANDLORD DUTY. I had described it as 'a live landlord duty' for the legal tracker. That was wrong. s2924.8(a) puts the duty on the TRUSTEE or authorized agent (posting on the property when a notice of sale is posted under s2924f) and on the MORTGAGEE, TRUSTEE, BENEFICIARY or authorized agent (mailing to 'Resident of property subject to foreclosure sale' with the s2924b notice of sale). The landlord is the borrower in that transaction, not the notifier. So the conclusion of this row gets STRONGER, not weaker: California imposes NO current statutory duty on a landlord to tell tenants or prospective tenants about a pending foreclosure. The pre-lease landlord duty (s2924.85) is repealed; the surviving foreclosure notice to residents runs through the lender side. What s2924.8 means for a landlord, as education only: s2924.8(d) confines it to residential loans where the billing address differs from the property address - i.e. precisely non-owner-occupied rental property - so a landlord's tenants WILL receive this notice if the property goes to sale. Its prescribed text, in English and every s1632 language, tells them the new owner may offer a new lease or give a 90-day notice, must honour a fixed-term lease except in limited cases, that just-cause cities may protect them further, and that their obligation to pay rent continues. Tearing it down within 72 hours is a $100 infraction. Operative 2021-03-01. The underlying tenant protections the notice summarises - the 90-day notice and fixed-term-lease rules - are in CCP s1161b and the federal Protecting Tenants at Foreclosure Act, NEITHER READ; the notice describes them but is not their source. | CA 2026-09-24 follow-up: CONFIRMED against the current Civil Code Div. 3, Pt. 4, Tit. 14, Ch. 2, Art. 1 section index (Justia reproduction; leginfo blocks automated access): it runs ss2920-2944.10 with no s2924.85 (sequence 2924.8 -> 2924.9 -> 2924.10); s2924.85 appears on Justia only under the 2016 code year. No successor: the surviving s2924.8 notice is a trustee/mortgagee duty to residents, not a landlord pre-lease disclosure.",
  },
  // Security Deposit
  {
    id: "edu-deposit-photo-duty-ca",
    title: "Security deposit photograph duties (2025)",
    group: "Security Deposit",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "deposit-photo-duty",
    bodyText:
      "California requires landlords to photograph the unit in connection with security deposit deductions. For tenancies beginning on or after July 1, 2025, the landlord must take photographs immediately before or at the inception of the tenancy. Beginning April 1, 2025, the landlord must photograph the unit within a reasonable time after possession is returned and before any repairs or cleaning that will be deducted, and again after that work is completed. Photographs must be provided to the tenant with the itemized statement wherever a deduction for repairs or cleaning is made.",
    notes: "CA: Civ. Code s1950.5(g)(1)-(2) and s1950.5(h)(2)(D), read section-open 2026-09-19. Two different commencement dates that are easy to conflate - the move-OUT photo duty started 2025-04-01 and applies to existing tenancies; the move-IN photo duty attaches only to tenancies that BEGIN on or after 2025-07-01. This is product work as much as lease text: the app should be prompting for and storing these photographs, and s1950.5(h)(2)(D) allows delivery by mail, email, flash drive or a link to online photographs.",
  },
  // Notices & General
  {
    id: "edu-municipal-layer-ca",
    title: "California municipal rent and eviction ordinances (out of scope)",
    group: "Notices & General",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "municipal-layer",
    bodyText:
      "Many California cities and counties impose their own rent stabilization and just-cause eviction rules that operate alongside or instead of state law. Civil Code section 1947.12(d)(3) yields to a local cap that is stricter than the state limit, and section 1946.2(i) provides that a local just-cause ordinance adopted on or before September 1, 2019, applies instead of the state scheme, as does a later ordinance that is more protective and contains a binding local finding to that effect. A property is never subject to both a local just-cause ordinance and section 1946.2.",
    notes: "CA: Scope flag only, NOT RESOLVED, per the state-level-only decision for this pass - same 'noted, not resolved' treatment as Denver/Boulder, Minneapolis/St. Paul and Ohio's cities. California's municipal layer is materially larger than any prior state's and the state statute expressly defers to it in both directions, so the two cannot be fully separated the way they could in CO or OH: for a covered unit in a just-cause city the state clause set may be displaced wholesale. Read section-open at s1946.2(i) and s1947.12(d)(3) 2026-09-19. This is the strongest case yet for revisiting the municipal scope boundary - stronger than the MN entry that currently holds that title.",
  },
  // Landlord Responsibilities
  {
    id: "edu-bed-bug-landlord-duties-ca",
    title: "Bed bug duties beyond the move-in disclosure",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "bed-bug-landlord-duties",
    bodyText:
      "California imposes three bed bug duties on landlords beyond the written disclosure given before a new tenancy. A landlord may not show, rent or lease a vacant unit the landlord knows has a current bed bug infestation. There is no duty to inspect for bed bugs absent notice of a suspected or actual infestation, but an infestation evident on visual inspection counts as notice. And where a pest control operator inspects units, the landlord must notify the tenants of those units of the operator's findings in writing within two business days of receiving them; for a confirmed infestation in a common area, all tenants must be notified.",
    notes: "CA: Civ. Code ss1954.602 and 1954.605, primary text supplied by Taylor 2026-09-19. The two-business-day written notice clock runs from the landlord's RECEIPT of the operator's findings, not from the inspection, and it is an affirmative duty with no tenant-request trigger - the kind of operational habitability duty the CO re-audit found the library systematically missed. s1954.602(b) is the landlord-protective limb worth knowing: no affirmative inspection duty absent notice, but visual evidence IS notice, so 'I never looked' is not a defence. No penalty appears in the chapter as supplied; enforcement route not researched.",
  },
  // Disclosures
  {
    id: "edu-mold-disclosure-contingency-ca",
    title: "California mold: a habitability duty, not a disclosure duty",
    group: "Disclosures",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "mold-disclosure-contingency",
    bodyText:
      "California treats mold as a habitability matter rather than a disclosure matter. Visible mold growth is listed as a substandard condition under Health and Safety Code section 17920.3(a)(13), and Civil Code section 1941.1(a) makes a dwelling untenantable if it is a residential unit described in section 17920.3. Two limits apply: the visible mold growth must be determined by a health officer or a code enforcement officer, and mold that is minor and found on surfaces that accumulate moisture as part of their properly functioning and intended use is excluded. Separately, the mold disclosure statute at Health and Safety Code section 26147 does not operate on its own terms - section 26147(e) suspends its requirements until six months after the department adopts permissible exposure limits and health guidelines and develops remediation guidelines. A landlord is never required to conduct air or surface testing for mold.",
    notes: "CA: REWRITTEN 2026-09-19 once H&S s17920.3 was read section-open. The earlier version of this row framed CA as possibly having NO mold obligation, which would have been the wrong conclusion - the duty exists, it just sits in habitability rather than disclosure. Both limbs now verified from primary text: s17920.3(a)(13) (mold listed, officer-determination required, minor-moisture-surface carve-out) and s26147(e) (disclosure duty contingent). The one thing still NOT verified is whether the s26103/s26105/s26130 standards were ever adopted - a factual question about departmental rulemaking, not a text question. It is widely reported they were not, and this row is drafted so that it stays accurate either way. CROSS-REFERENCE for the base habitability clause screen: s1941.1(a)'s incorporation of s17920.3 pulls a 16-item inadequate-sanitation list plus structural, wiring, plumbing, mechanical, weather-protection and fire limbs into CA's tenantability standard - far broader than the seven affirmative characteristics in s1941.1(a)(1)-(7) that a reader stopping at the enumerated list would see. Note s17920.3(a)(12) subjects insect, vermin and rodent infestation to the same officer-determination requirement as mold. ADDED 2026-09-19: Civ. Code s1941.7(a) - no s1941 or s1942 duty to repair a mold dilapidation under H&S s17920.3(a)(13) arises until the lessor HAS NOTICE of it, or if the tenant is in violation of s1941.2. s1941.7(b) permits entry to repair mold subject to s1954. So CA's mold duty is notice-triggered as well as officer-determined. RESOLVED 2026-09-19: CDPH never adopted the s26103 PELs (2005 Report to the Legislature; 2017 Statement on Indoor Dampness and Mold). The contingency has never been satisfied. The row's drafting - accurate either way - no longer needs to hedge.",
  },
  // Rent & Payment
  {
    id: "edu-nsf-treble-damages-ca",
    title: "Returned-check service charge and treble damages are alternatives",
    group: "Rent & Payment",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "nsf-treble-damages",
    bodyText:
      "California gives the payee of a bad check two separate remedies, and a landlord cannot have both. The service charge is capped at $25 for a first check and $35 for each subsequent one. Alternatively, the landlord may pursue treble damages, but only after mailing a written demand by certified mail that states the provisions of the statute, the amount of the check, and the amount of the service charge, and then waiting 30 days for payment. Treble damages are not less than $100 and not more than $1,500. Once a tenant becomes liable for treble damages on a check, the tenant is no longer liable for the service charge or the mailing costs on that check. A tenant is liable only once per check.",
    notes: "CA: Civ. Code s1719(a)(2), together with (h)-(k) from the partial text supplied earlier. The election point is the trap: s1719(a)(2)'s closing sentence extinguishes the service charge once treble liability attaches, so a landlord demanding both is overreaching. Three MANDATORY contents in the certified-mail demand - miss one and the treble claim fails. Partial payments within the 30 days reduce the base before trebling. s1719(h) makes the remedies mandatory upon a court; (i) lets an assignee or holder enforce them; (j)(2) caps exposure at once per check; (k) preserves Commercial Code Division 3 rights and defences including holder-in-due-course status. Routed to LANDLORD_EDUCATION rather than lease text because it is an enforcement procedure, consistent with the project's notice-and-cure routing decision.",
  },
  // Disclosures
  {
    id: "edu-meth-fentanyl-disclosure-duties-ca",
    title: "Methamphetamine or fentanyl remediation order: disclosure mechanics",
    group: "Disclosures",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "meth-fentanyl-disclosure-duties",
    bodyText:
      "Where a local health officer has issued a methamphetamine or fentanyl remediation order affecting a property, the owner's disclosure duty to prospective tenants continues until the owner receives written notice from the health officer that the property requires no further action. During that period the owner must give written notice of the order to every prospective tenant who has completed a rental application, provide a copy of the order, obtain the tenant's written acknowledgment of receipt before the rental agreement is signed, and attach the notice to the rental agreement. A prospective tenant may void the rental agreement if the owner does not do all of this.",
    notes: "CA: H&S s25400.28(b), read section-open 2026-09-19. Routed to education because three of the four obligations are procedural and occur before signature - the lease clause alone cannot discharge them. The application-stage trigger is the one most likely to be missed by a product that only generates documents at lease time. Void-the-agreement is the remedy; no damages provision appears in the subdivision.",
  },
  // Pets
  {
    id: "edu-assistance-animal-documentation-ca",
    title: "Assistance animals: what a landlord may ask and require",
    group: "Pets",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California limits how a housing provider may verify an assistance animal. For a service animal, only two questions may be asked: whether the person is an individual with a disability, and what disability-related task the animal has been trained to perform. The person may not be asked to demonstrate the task. Service animals need not be professionally trained or certified. Animal vests, identification cards and certificates are not by themselves documentation of a disability or of the need for an accommodation. A support animal certification bought from an online service, without an individualized assessment by a medical professional, is presumptively not reliable third-party information - but before denying the request the housing provider must give the individual an opportunity to supply information that does meet the standard. A denial for direct threat must rest on an individualized assessment of objective evidence about that specific animal's actual conduct, not on speculation, fear, or what other animals have done.",
    notes: "CA: 2 CCR s12185(b), (c)(2), (d)(7) and (d)(9)(B)-(D), plus s12005(d)(1), read section-open 2026-09-19. The online-certification presumption at (c)(2) is the landlord-favourable limb most likely to be misapplied - it is a presumption about the RELIABILITY of one document, not a licence to deny, and the regulation expressly requires giving the tenant a chance to cure the documentation first. An individualized assessment must show the disability, describe the accommodation INCLUDING THE SPECIES, and connect the two. s12185(d)(9)(D): a dog finally determined by a court to be a 'potentially dangerous dog' or 'vicious dog' under Food & Agric. Code s31601 et seq. is PRESUMPTIVELY a direct threat - the one bright line in an otherwise individualized standard.",
  },
  // Compliance & Prohibited Terms
  {
    id: "edu-translation-duty-ca",
    title: "Lease translation duty (five languages)",
    group: "Compliance & Prohibited Terms",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California requires a landlord who negotiates a lease primarily in Spanish, Chinese, Tagalog, Vietnamese or Korean to deliver the tenant a full translation of the lease, including every term and condition, before the lease is signed, and to provide a notice in that language at the time and place of signing. The duty applies only to a tenancy for a period longer than one month. It does not apply where the tenant negotiated through the tenant's own interpreter, meaning an adult fluent in both languages who is not employed by or supplied through the landlord. House rules and furnishing inventories ordinarily incorporated by reference do not have to be translated, but a later document making substantial changes to the parties' rights does. The English lease governs the parties' rights; the translation is admissible only to show that no contract was formed because of a substantial difference in material terms. A tenant may rescind the lease if the landlord does not comply, and any waiver of these requirements is void.",
    notes: "CA: Civ. Code s1632, primary text supplied by Taylor 2026-09-19 (amended by SB 1103, Stats. 2024 ch. 1015, eff. 2025-01-01). This is the duty s1946.2(f)(3) and Gov. Code s8589.45(b) both invoke, now read at source. Findings that change how the app must treat it: (1) SCOPE LIMIT - s1632(b)(3) reaches a tenancy 'for a period of longer than one month' only, so a pure month-to-month tenancy is OUTSIDE the duty. That is a large carve-out nobody would guess from the cross-references in s1946.2 or s8589.45. (2) The trigger is negotiating PRIMARILY in the language, orally OR in writing - not the tenant's stated preference. (3) REMEDY IS RESCISSION of the lease, s1632(k)(1); waiver void, s1632(l). (4) s1632(g)(3) excludes matters ordinarily incorporated by reference - tenancy rules and regulations and furnishing inventories - from the 'contract' to be translated. s1632(g)(1) INCLUDES any later document making substantial changes, so a material amendment re-triggers the duty. (5) s1632(h) own-interpreter exception, with the interpreter defined as a non-minor fluent in both languages and NOT employed by or made available through the landlord. (6) s1632(i) permits retaining names, addresses, brand names, numerals, dollar amounts and dates untranslated; s1632(j) makes the ENGLISH text controlling. PRODUCT IMPLICATION, escalated not solved: for a covered lease the app must generate a complete translated lease, not a translated disclosure. That is a capability the schema and builder do not have, and it is the second half of the type-size/translation schema gap recorded in the CA decision log.",
  },
  {
    id: "edu-lease-waiver-void-ca",
    title: "Lease provisions void as contrary to public policy, and the before-possession rule",
    group: "Compliance & Prohibited Terms",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "lease-waiver-void",
    bodyText:
      "California voids two categories of lease provision outright. First, any provision by which a tenant agrees to modify or waive rights or remedies under the security deposit statute or the landlord entry statute, the right to assert a future cause of action against the landlord, the right to a notice or hearing required by law, procedural rights in litigation over the tenancy, or the right to have the landlord exercise a duty of care imposed by law to prevent personal injury or personal property damage. Second, any provision modifying or waiving any other statutory right is void unless the lease was presented to the tenant before the tenant took actual possession of the premises. That second rule does not apply to a renewal that carries forward the same provision from the agreement being renewed. Both rules apply to leases executed on or after January 1, 1976.",
    notes: "CA: Civ. Code s1953 (Hiring of Real Property chapter), primary text supplied by Taylor 2026-09-19. NOTE this is CIVIL CODE s1953, not CCP s1953 - see the cross-body citation ambiguity topic. s1953(a)(5) is the operative bar for the library's exculpation rows and it is MUCH CLOSER TO OHIO s5321.13(D) than s1668 is: it voids any waiver of the tenant's right to have the landlord exercise a duty of care imposed by law to prevent PERSONAL PROPERTY DAMAGE, which is exactly what a blanket 'Landlord is not liable for loss or damage to Tenant's personal property' clause does. s1953(a)(2) is broader still - it voids waiver of the right to assert ANY future cause of action against the lessor, which reaches blanket not-liable and landlord-indemnity limbs generally. See the CA extend manifest: this supersedes my earlier read that s1668 alone might permit a merely narrowed clause. s1953(a)(1) bars contracting around s1950.5 or s1954 at all, which is why security-deposit-cap-ca, security-deposit-return-ca and landlord-entry-ca must track the statutes rather than vary them. s1953(b) IS THE SLEEPER and has no analogue anywhere in the library: a provision modifying or waiving any OTHER statutory right is void UNLESS THE LEASE WAS PRESENTED TO THE TENANT BEFORE THE TENANT TOOK ACTUAL POSSESSION. A lease signed after move-in loses every statutory-right modification it contains. Carve-out: renewals carrying forward the same provision. This is a document-TIMING rule, not a drafting rule, and the app is the only thing that can enforce it. s1953(c): applies to leases executed on or after 1976-01-01. NOT RESOLVED: s1953(a)(4) 'procedural rights in litigation' plainly reaches some jury-waiver, venue and fee-shifting limbs, but how far is case law, not text - not researched. ss1942.1 and 1942.5, cross-referenced in s1953(b), remain unread. CONFESSION OF JUDGMENT, added 2026-09-19: CCP s1132(a) - 'a judgment by confession is unenforceable and may not be entered in any superior court', for judgments obtained or entered on or after 2023-01-01 (s1132(b)). So a confession-of-judgment or cognovit clause is dead in CA by a flat statutory bar, not merely void as a s1953(a)(4) waiver of procedural rights. Screen the base library for any such clause.",
  },
  {
    id: "edu-accommodation-process-ca",
    title: "Disability accommodations: the interactive process and inquiry limits",
    group: "Compliance & Prohibited Terms",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "accommodation-process",
    bodyText:
      "When a landlord cannot immediately grant a requested accommodation or modification, California requires the landlord to engage in a timely, good-faith interactive process with the tenant. A request may not be denied for lack of information without first asking for the missing information and giving the tenant a reasonable opportunity to supply it, and undue delay in responding can itself amount to a denial. What the landlord may ask depends on what is already apparent: if the disability and the need are apparent or known, no further information may be requested at all; if only the need is unclear, the landlord may ask only for a description of the accommodation and how it relates to the disability. A landlord may never ask about the tenant's diagnosis, the severity of the disability, medical records, or medical history. A tenant can often establish disability by self-certification, such as proof of receipt of disability benefits or a credible statement. All information about a disability or a request must be kept confidential. Where the need for an accommodation arises from the landlord's own failure to maintain or repair the property as required by law, the undue-burden and fundamental-alteration defenses do not apply.",
    notes: "CA: 2 CCR ss12176(e), 12177, 12178 and 12179, read section-open 2026-09-19. Far more operationally detailed than any prior state's accommodation rules. Items with no analogue anywhere in the library: s12176(e) CONFIDENTIALITY - disability and request information may not be shared with anyone not directly involved in the interactive process or decision, save four exceptions (needed to decide, needed to implement, written authorization, required by law). A standalone landlord duty. s12177(b) - may NOT deny for lack of information without first requesting it and allowing a reasonable opportunity to respond; s12177(e) - undue delay MAY ITSELF CONSTITUTE DENIAL; s12177(c) - must look for an equally effective alternative and must grant one that works, with the tenant's preference given significant weight; s12177(g) - a later request for the same accommodation must be considered independently of an earlier denial. s12178 tiered inquiry (a)-(e), with s12178(e)(1) barring any inquiry into diagnosis, severity, medical records or medical history; s12178(f) SELF-CERTIFICATION; s12178(g) five categories of reliable third party including peer support groups and non-medical service agencies; s12178(h) case-by-case reliability test. s12179(d)(6) - where the need arises from the owner's failure to maintain or repair as required by law, the undue-burden and fundamental-alteration defenses ARE UNAVAILABLE. s12176(f)(8) - failure to accommodate is an AFFIRMATIVE DEFENSE to an unlawful detainer, and a request may be made during the eviction, at trial, or after judgment. This belongs in the legal tracker's eviction workflow, not only in the lease. s12181 (modifications: restoration, escrow, who pays) NOT READ.",
  },
  // Landlord Responsibilities
  {
    id: "edu-retaliation-ca",
    title: "Retaliation: the 180-day window and what counts",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "retaliation",
    bodyText:
      "California bars a landlord from recovering possession, causing a tenant to quit involuntarily, increasing rent, or decreasing services within 180 days of a tenant exercising rights relating to tenantability, where the tenant is not in default on rent. The triggering events include the tenant giving repair notice, giving notice of a suspected bed bug infestation, making an oral complaint about tenantability, filing a complaint with an agency, an inspection or citation resulting from such a complaint, commencing a proceeding involving tenantability, and a judgment on tenantability against the landlord; where more than one applies, the 180 days run from the latest. A tenant may invoke this protection only once in any 12-month period. Separately, and without that time limit, it is unlawful to retaliate because a tenant organized or participated in a tenants' association or lawfully exercised any legal right. Threatening to report a tenant, or anyone the landlord knows to be associated with the tenant, to immigration authorities is retaliatory conduct under both rules. A landlord may still act within the 180 days for a lawful reason if the notice states the good-faith ground relied on, and must prove that ground if it is challenged. A landlord who violates the section is liable for actual damages plus punitive damages of $100 to $2,000 for each retaliatory act involving fraud, oppression or malice, and the court awards attorney's fees to the prevailing party if either party requests them when the action begins. Any waiver of these protections is void.",
    notes: "CA: Civ. Code s1942.5, primary text supplied by Taylor 2026-09-19 (operative 2021-10-01 per s1942.5(l); amended by AB 832, Stats. 2021 ch. 27). Points the library has no analogue for: s1942.5(c) and (e) - THREATENING TO REPORT THE TENANT OR ANYONE ASSOCIATED WITH THE TENANT TO IMMIGRATION AUTHORITIES is expressly retaliatory under both the (a) and (d) prohibitions. No prior state has an immigration-based retaliation provision. s1942.5(k) carves out compliance with federal rent-limitation or rental-assistance program obligations. s1942.5(a)(1) expressly lists NOTICE OF A SUSPECTED BED BUG INFESTATION as a trigger, which ties this directly to bed-bug-disclosure-ca and edu-bed-bug-landlord-duties-ca - a tenant report under that chapter starts a 180-day retaliation clock. TWO DISTINCT PROHIBITIONS, easily collapsed: (a) is the 180-day tenantability window, limited to a tenant not in default on rent and invokable once per 12 months (s1942.5(b)); (d) is a separate, untimed ban on retaliation for tenant organizing or lawfully exercising ANY right, with the burden of producing evidence on the TENANT. Do not merge them. s1942.5(g) is the landlord's safe harbour and it is a DRAFTING duty: the notice must state the good-faith ground relied on, and the landlord must establish its truth if controverted - which dovetails with the s1946.2 just-cause statement requirement. s1942.5(i) is a RECIPROCAL FEE PROVISION triggered by either party requesting fees at initiation - relevant to the default-by-tenant / attorney-fee reciprocity question flagged in the CA extend manifest. s1942.5(f): waiver void as contrary to public policy, independent of s1953. ADDED 2026-09-19: Civ. Code s1942.6 - a person entering on an occupant's invitation, during reasonable hours or in an emergency, to provide information on tenants' rights or to participate in a tenants' association is NOT LIABLE FOR TRESPASS. Complements the s1942.5(d) protection of tenant organising.",
  },
  {
    id: "edu-screening-fee-ca",
    title: "Application screening fees",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "screening-fee",
    bodyText:
      "A landlord may charge an application screening fee only to cover the actual cost of screening, capped at a statutory amount that is adjusted annually for inflation, and may not charge one at all when the landlord knows or should know that no unit is or will soon be available. The landlord must also operate one of two processes: either consider completed applications in the order received against written screening criteria given to the applicant with the application form and approve the first applicant who meets them, or return the entire fee to every applicant not selected within seven days of selecting a tenant or thirty days of the application, whichever comes first. The landlord must give the applicant an itemized receipt, refund any part of the fee not actually used, and give the applicant a copy of any consumer credit report obtained within seven days of receiving it.",
    notes: "CA: Civ. Code s1950.6, primary text supplied by Taylor 2026-09-19. AMENDED BY AB 1170, Stats. 2025 ch. 67, EFFECTIVE 2026-01-01 - one of the most recently changed provisions in the CA set, and squarely in the legal-watch zone. DO NOT HARDCODE $30. s1950.6(b) caps the fee at the lesser of actual out-of-pocket cost plus the reasonable value of time spent, or $30 per applicant, BUT the $30 'may be adjusted annually by the landlord or their agent commensurate with an increase in the Consumer Price Index, beginning on January 1, 1998'. The operative figure today is therefore a CPI-indexed number well above $30, computed from a 1998 base, and it is landlord-computed rather than published. Body text deliberately says 'a statutory amount adjusted annually for inflation' rather than stating a number. The app should not assert a figure it cannot derive. s1950.6(c)(2) is the structural obligation and it is new to this project: the landlord must OFFER one of two defined processes - (A) first-come-first-considered against written criteria supplied WITH THE APPLICATION FORM, first qualifying applicant approved, no fee until the application is actually considered, with a 7-day refund for inadvertent duplicate collection (or, at the applicant's option, transfer to another unit); or (B) full refund to every non-selected applicant within 7 days of selection or 30 days of application, whichever is first. This is product workflow, not lease text. s1950.6(c)(1): no fee where the landlord knows or should know no unit is or will soon be available. s1950.6(d) itemized receipt; (e) refund of the unused portion where no reference check or credit report was obtained; (f) copy of the consumer credit report to the applicant within 7 days of receipt. s1950.6(k): the fee is NOT 'security' under s1950.5 and not an 'advance fee' - so it sits outside the AB 12 deposit cap entirely. s1950.6(j) includes GUARANTORS AND COSIGNERS in 'applicant'. s1950.1 READ 2026-09-19 - see edu-reusable-screening-report-ca. The interaction matters: s1950.1(d) applies 'notwithstanding Section 1950.6', so a landlord who elects to accept reusable reports may charge an applicant who supplies one NEITHER an access fee NOR an application screening fee at all.",
  },
  // Default & Termination
  {
    id: "edu-three-day-notice-ca",
    title: "Three-day notice content and service",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "three-day-notice",
    bodyText:
      "California's three-day notices are governed by statute rather than by the lease. The three days exclude Saturdays, Sundays and judicial holidays. A notice demanding rent must state the amount due and the name, telephone number and address of the person to whom rent is to be paid, with the usual days and hours that person is available if payment may be made personally; alternatively it may give a financial institution account number with the institution's name and street address, provided the institution is within five miles of the rental property, or refer to an electronic funds transfer procedure already established. It must be served on the tenant and on any subtenant in actual occupation, and may be served at any time within one year after the rent becomes due. A notice to perform other covenants gives the tenant, a subtenant, a mortgagee or another interested person three days to perform and save the lease from forfeiture, and no such notice is required where the violated covenant can no longer be performed. Assigning or subletting contrary to the lease, committing waste, maintaining a nuisance or using the premises for an unlawful purpose terminates the lease and supports a three-day notice to quit with no opportunity to cure. Notices may be served by personal delivery; by leaving a copy with a person of suitable age and discretion at the tenant's residence or usual place of business and mailing a copy to the residence; or, where neither can be ascertained and no suitable person is found, by posting conspicuously on the property, delivering to a person residing there if one can be found, and mailing to the property. A landlord may not charge any fee for serving, posting or delivering these notices.",
    notes: "CA: CCP ss1161 and 1162, primary text supplied by Taylor 2026-09-19. s1161 amended by SB 611 (Stats. 2024 ch. 287), OPERATIVE 2025-02-01. Routed to LANDLORD_EDUCATION per the standing decision to send notice-and-cure mechanics to the legal tracker rather than into lease text. The s1161(2) content list MIRRORS Civ. Code s1962 almost exactly, INCLUDING THE FIVE-MILE FINANCIAL-INSTITUTION LIMIT and the conclusive-presumption-on-mailing proviso. The two must stay consistent: the lease disclosure under owner-identity-disclosure-ca supplies the same facts the pay-or-quit notice must recite, and s1962(c) separately bars a non-compliant SUCCESSOR owner from serving a s1161(2) notice for rent accrued during noncompliance. Getting the lease disclosure wrong therefore breaks the eviction notice too. The three days EXCLUDE Saturdays, Sundays and judicial holidays, in both s1161(2) and the s1161(3) cure window. A one-year outer limit applies to serving a rent notice. s1161(3): the cure right runs to the tenant, a subtenant in actual occupation, a MORTGAGEE OF THE TERM, or another person interested in its continuance - broader than the tenant alone. No notice is required where the violated covenant cannot afterward be performed. s1161(4): assignment or subletting contrary to the lease, waste, nuisance or unlawful purpose TERMINATES the lease by operation of the statute and supports a three-day notice to quit with NO cure right. Cross-references Civ. Code ss3482.8, 3485(c) and 3486(c), ALL READ 2026-09-19 - see edu-nuisance-eviction-assignment-ca. Only s3482.8 (dogfighting/cockfighting) is statewide. s3486 applies ONLY in the City of Los Angeles. s3485 APPEARS TO BE REPEALED as of 2024-01-01 by its own s3485(j), which means s1161(4) carries a cross-reference to a section that no longer exists - and s1161 was itself amended by SB 611 in 2024 and made operative 2025-02-01 without fixing it. Do not treat the s1161(4) deemed-nuisance list as three live statewide grounds; as read, it is one statewide ground, one city-specific ground, and one dead pointer. s1161(7): 'tenant' excludes occupancies described in Civ. Code s1940(b), READ 2026-09-19 - see edu-tenancy-scope-ca. Two exclusions: transient occupancy subject to transient occupancy tax under R&T s7280, and hotel/motel occupancy where the innkeeper retains a right of access AND all five listed services are offered. Anyone outside those exclusions is a 'tenant' for s1161 purposes. s1162(a) gives the three residential service methods; s1162(b)-(c) are commercial and out of scope. Note s1946.1(f) permits certified or registered mail as an ALTERNATIVE to s1162 service for a periodic-tenancy termination, whereas s1162 does not list mail alone as a method - the two regimes differ and must not be merged in the tracker. INTERACTION NOT RESOLVED: s1946.2(c) requires a cure opportunity 'pursuant to paragraph (3) of Section 1161' before a just-cause termination for a curable breach; how that sequences against a s1161(4) no-cure ground has not been worked through.",
  },
  // Notices & General
  {
    id: "edu-tenancy-scope-ca",
    title: "Who counts as a tenant, and which occupancies fall outside the chapter",
    group: "Notices & General",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California's residential landlord-tenant chapter applies to everyone who hires a dwelling unit in the state, including tenants, lessees, boarders and lodgers, however they are described in the agreement. A dwelling unit means a structure or part of a structure used as a home, residence or sleeping place by one person maintaining a household or by two or more people maintaining a common household. Two occupancies are outside the chapter: transient occupancy in a hotel, motel, residence club or similar facility where the stay is subject to transient occupancy tax, and occupancy at a hotel or motel where the innkeeper keeps a right of access to and control of the unit and the establishment offers all of five services to every resident - personal property safekeeping, central telephone service under filed tariffs, maid, mail and room services, occupancy for periods of less than seven days, and food service from an establishment on or next to the premises connected to the innkeeper. Unless a particular provision says otherwise by its own terms, the chapter's provisions apply to a tenancy in a dwelling unit.",
    notes: "CA: Civ. Code s1940, read section-open 2026-09-19, together with s1961 for the separate Chapter 4 disclosure scope. Matters for a property-management product because it decides whether the whole CA clause set applies at all. s1940(a) reaches 'boarders, lodgers, and others, HOWEVER DENOMINATED', so calling an agreement a licence, a room-share or a lodging arrangement does not move it out of the chapter. s1940(b)(2): the hotel/motel exclusion is CONJUNCTIVE - the innkeeper must retain a right of access AND ALL FIVE services must be offered to all residents. A short-stay operator missing any one of the five is inside the chapter and owes the full CA clause set. This is the provision a short-term-rental operator is most likely to assume protects them. s1940(d) is a construction rule worth keeping: nothing limits the application of any Chapter 2 provision to a tenancy in a dwelling unit UNLESS the provision is so limited by its specific terms - i.e. read the chapter broadly by default. READING FLAGGED, NOT ASSERTED: s1940(b)(1) contains a double negative - the transient exclusion does not apply to 'a person to whom this paragraph pertains if the person has not made valid payment for all room and other related charges owing as of the last day on which his or her occupancy is or would be subject to tax'. On its face that keeps a non-paying transient OUTSIDE the chapter, but the sentence is genuinely awkward and the practical question - when a hotel guest who overstays becomes a tenant entitled to unlawful-detainer process - is the kind of thing that turns on case law. NOT researched. Do not build occupancy-type logic on this subdivision without confirming it. s1940(c)'s 'dwelling unit' definition is also the hinge for CCP s1162(c)'s commercial-tenant carve-out, so the two travel together. R&T s7280 READ 2026-09-19 and it supplies the operative line: s7280(a) authorises the tax on occupancy of a hotel, inn, tourist home, motel or other lodging 'UNLESS THE OCCUPANCY IS FOR A PERIOD OF MORE THAN 30 DAYS'. Because s1940(b)(1) excludes occupancy that IS OR WOULD BE subject to that tax, the 30-day line governs even in a jurisdiction that never levied one. So a stay of MORE THAN 30 DAYS is outside the transient exclusion and inside Chapter 2, subject still to the separate s1940(b)(2) five-service hotel exclusion. That is the concrete boundary a short-stay operator needs. s7280(c) also sweeps campground and RV-park spaces into 'other lodging', while excluding local-government facilities, time-share owner occupancy and s7282 campsites. The s1940(b)(1) non-payment double negative flagged above is a SEPARATE question and is still unresolved. EXCEPTION ADDED 2026-09-19: Civ. Code s1940.1 bars requiring a residential hotel occupant to move or check out and re-register before 30 days for the purpose of preserving transient status, with a rebuttable presumption of that purpose from any required check-out ($500 civil penalty). And Civ. Code s1954.071 moves the line from 30 days to 270 for DISASTER-DISPLACED guests until 2031-01-01 - see edu-disaster-displaced-guests-ca.",
  },
  // Landlord Responsibilities
  {
    id: "edu-reusable-screening-report-ca",
    title: "Reusable tenant screening reports",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "reusable-screening-report",
    bodyText:
      "California lets a rental applicant supply a reusable tenant screening report - a consumer report prepared within the previous 30 days at the applicant's own request and expense, made available to the landlord at no cost either directly or through a third-party service. Such a report must include the applicant's name and contact information, verification of employment, last known address, and the results of an eviction history check, and must state prominently the date through which its information is current. A landlord is not required to accept these reports. A landlord who does accept them may ask the applicant to confirm that nothing in the report has materially changed, but may not charge that applicant any fee to access the report and may not charge an application screening fee at all. Where a local ordinance conflicts with these rules, whichever gives applicants greater protection applies.",
    notes: "CA: Civ. Code s1950.1, primary text supplied by Taylor 2026-09-19 (added by AB 2559, Stats. 2022 ch. 288, eff. 2023-01-01). Closes the s1950.6(g) dependency. THE DECISION POINT IS BINARY AND HAS A PRICE: s1950.1(h) says a landlord need not accept reusable reports, but s1950.1(d) provides that IF the landlord accepts them and an applicant supplies one, the landlord may charge NEITHER an access fee NOR an application screening fee - 'notwithstanding Section 1950.6'. So electing to accept them forfeits screening-fee revenue from every applicant who brings one. The app should surface this as a landlord-level setting, not a per-application choice. s1950.1(e)(6): the report must have been prepared WITHIN THE PREVIOUS 30 DAYS, at the applicant's request AND EXPENSE, and be available to the landlord AT NO COST - a report the landlord must pay to access is not a reusable screening report and does not trigger the fee ban. s1950.1(g) is a one-way local-preemption rule: where a local policy conflicts, whichever gives APPLICANTS GREATER PROTECTION applies. Third CA provision found deferring to the municipal layer, after s1946.2(i) and s1947.12(d)(3), and it reinforces edu-municipal-layer-ca. UNREAD AREA SURFACED BY s1950.1(f): criminal-history consideration in housing is governed by 2 CCR Art. 24, s12264 et seq. (Civil Rights Council again) plus local ordinances. That is an entire tenant-screening regulatory area this pass has NOT touched and it is not in the canvass. Flagging it as a gap-discovery find, not resolving it.",
  },
  // Default & Termination
  {
    id: "edu-nuisance-eviction-assignment-ca",
    title: "Nuisance-based eviction and the city-prosecutor assignment",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "nuisance-eviction-assignment",
    bodyText:
      "California deems certain conduct a nuisance for the purpose of a three-day notice to quit, but the provisions are narrower than they appear. Using a building or property for dogfighting or cockfighting is a public nuisance statewide. A separate controlled-substance eviction procedure lets a city prosecutor or city attorney bring an unlawful detainer action, but it operates only in the City of Los Angeles. Under that procedure the prosecutor must first give the owner 30 calendar days' written notice requiring the owner to act, and the owner must within 30 days either supply all relevant information or give a written safety-related explanation together with an assignment of the right to bring the action. Accepting the assignment can cost the owner up to $600 in investigation, discovery and attorney's fees. If the owner does not act, or does not prosecute the action diligently and in good faith, the prosecutor may file and join the owner as a defendant, and on a finding of unlawful detainer the prosecutor's costs may be assessed against the owner and recorded as a lien on the property. The court may order a partial eviction removing only the person involved and barring their return, rather than ending the whole tenancy.",
    notes: "CA: Civ. Code ss3482.8, 3485 and 3486, primary text supplied by Taylor 2026-09-19. These are the three sections CCP s1161(4) incorporates as deemed nuisances. Reading them changes what that limb is worth. s3482.8 (added SB 426, eff. 2012-01-01): dogfighting under Pen. Code s597.5 or cockfighting under s597b(b) - STATEWIDE, and the only one of the three that is. s3486: controlled-substance purpose, defined at s3486(c) by a long list of H&S Code offences. s3486(g): 'This section applies ONLY IN THE COUNTY OF LOS ANGELES to a court having jurisdiction over unlawful detainer cases involving real property situated in the CITY OF LOS ANGELES.' s3486(h) further conditioned its 2014 operativity on the City of LA's reporting compliance. s3485 (unlawful weapons or ammunition): APPEARS REPEALED. s3485(j) reads 'This section shall remain in effect only until January 1, 2024, and as of that date is repealed', and the codifier's annotation says 'Repealed as of January 1, 2024, by its own provisions.' Corroborating but not conclusive: the text supplied is served as the 2022 California Code while ss3482.8 and 3486 came as 2025, which is what a publisher does when a section has left the current code. Same evidentiary posture as s2924.85 - strong, one notch below CITED. CONFIRM against the current Civil Code index at sync. SECOND INSTANCE OF CROSS-REFERENCE ROT IN CA, and worse than the 2 CCR s12178(f) case: there the target existed but had been re-lettered; here the target is GONE, and CCP s1161(4) was amended by SB 611 in 2024 and made operative 2025-02-01 while still citing it. LANDLORD EXPOSURE is the reason this is an education row rather than a footnote: s3486(a)(1)(E) puts up to $600 of the prosecutor's costs on the owner upon acceptance of an assignment, and s3486(a)(3) assesses the prosecutor's costs against the DEFENDANT OWNER with an abstract of judgment becoming A LIEN ON THE PROPERTY. An owner who ignores a 30-day notice can be joined as a defendant in an action against their own tenant. s3486(b) partial eviction: the court may remove and permanently bar an individual, including a household member, without terminating the tenancy, and may condition the remaining tenancy on the others not inviting that person back. s3486(f)(2)(B) gives the tenant an extreme-hardship stay on clear and convincing evidence, expressly NOT available on economic hardship alone. s3486(a)(5) preserves CCP s1179 relief from forfeiture - NOT READ. TYPE SIZE AND TRANSLATION AGAIN: s3486(a)(1)(C) requires the tenant notice in at least 14-POINT BOLD TYPE and in English plus all the s1632 languages. Fifth type-size floor found in CA and a third s1632 linkage - though this notice is the prosecutor's to serve, not the landlord's, so it is not lease content. s3485 EVIDENCE UPGRADED 2026-09-19, WITH A CAVEAT THE s2924.85 REPEAL DOES NOT CARRY: AB 2930 (Stats. 2018 ch. 880) as enacted on leginfo sunsets s3485 on 2024-01-01; the federal OJP National Gang Center legislation index, citing LexisNexis, lists it 'Repealed effective January 1, 2024'; Justia's latest version is 2022. BUT s3485 HAS BEEN REPEALED AND REVIVED BEFORE - AB 1013 (2007), AB 530 (2009), AB 2310 (2014, re-adding it after a lapse) and AB 2930 (2018). The 2014 revival came AFTER a lapse, so a post-2024 revival is plausible on the section's own history. Two targeted searches found every prior revival and NONE after 2018; per the two-attempt rule the search stopped there. Treat as repealed, but this is the one row in the CA set where a legal-watch hit is genuinely likely: watch for any bill adding s3485 to the Civil Code. FULL s3485 TEXT READ 2026-09-19 (2022 version, the last published): s3485(j) confirms the 2024-01-01 sunset from the section's own words, not just the enacting bill. SCOPE WHILE IN FORCE, s3485(f): only courts with unlawful detainer jurisdiction over property in the CITIES OF LOS ANGELES, LONG BEACH, SACRAMENTO AND OAKLAND - four cities, against s3486's one. So the named-locality pattern is stronger than recorded: both sibling sections were city-confined, to different city lists. While operative it also required a tenant notice in at least 14-POINT BOLD type, translated into every s1632(b) language, and conditioned the prosecutor's standing on annual reporting to the California Research Bureau (s3485(g)-(i)). This text does NOT resolve the revival caveat: a 2022 version shows what was repealed, not whether anything was re-added after 2024. The legal-watch item stands. REVIVAL CAVEAT NARROWED 2026-09-19: Justia's code pages are published by code year, and the s3485 page Taylor supplied is headed '2022 California Code' while every current section in this pass is headed '2025 California Code'. A section re-added by any 2023-2025 enactment would carry a later-year page. So no revival through the 2025 code year; only the CURRENT (2026) legislative session remains unchecked. Treated as repealed.",
  },
  {
    id: "edu-forfeiture-redemption-ca",
    title: "Forfeiture election and the five-day redemption window",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "forfeiture-redemption",
    bodyText:
      "In California a judgment in an unlawful detainer action declares the lease forfeited only if the three-day notice stated the landlord's election to declare a forfeiture. If the notice did not say so, the lease is not forfeited. Separately, where the action is for nonpayment of rent, the lease has not expired by its own terms and the notice did not elect forfeiture, the court may delay the writ for five days after judgment so that the tenant, a subtenant, a mortgagee or another interested party can pay the rent, damages and costs and be restored to the tenancy. That five-day delay is mandatory rather than discretionary where the lease is in writing, is for a term of more than one year, and contains no forfeiture clause.",
    notes: "CA: CCP s1174(a) and (c), read section-open 2026-09-19. Routed to education because it governs notice drafting and post-judgment procedure rather than lease text. s1174(a) is a NOTICE-DRAFTING TRAP: omit the election to declare forfeiture from the s1161 notice and the lease survives the judgment. Belongs in the legal tracker's notice generator. s1174(c) IS A FOURTH INSTANCE OF THE OPT-IN PATTERN, and this time the opt-in runs the landlord's way: the five-day mandatory redemption window applies only where the written lease of more than one year 'DOES NOT CONTAIN A FORFEITURE CLAUSE'. Including a forfeiture clause removes the mandatory stay and leaves it discretionary. That is a real drafting decision the library currently does not surface, and it should be weighed against s1174(a)'s requirement that the notice elect forfeiture. NOT drafted as a clause here - flagged for Taylor's decision. s1174(e)-(m) carry an entire abandoned-personal-property regime cross-referencing Civ. Code ss1980-1991, with landlord non-liability safe harbours at (j)-(l). NONE OF THOSE SECTIONS READ - this is an unexplored area and the library has no CA abandoned-property row.",
  },
  // Access & Entry
  {
    id: "edu-no-periodic-inspection-ca",
    title: "No general right of periodic inspection",
    group: "Access & Entry",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "periodic-inspection",
    bodyText:
      "California limits landlord entry to the purposes listed in Civil Code section 1954. A general right to conduct periodic inspections of an occupied dwelling is not among them. The only inspection the statute provides for is the initial inspection a tenant may request before the end of the tenancy under Civil Code section 1950.5(f). Entry to make necessary or agreed repairs, to supply agreed services, or to show the unit is permitted, but a lease term reserving periodic inspections has no statutory basis and any waiver of section 1954 rights is void under Civil Code section 1953(a)(1).",
    notes: "CA: CONFIRMED ABSENT 2026-09-19 from Civ. Code s1954(a) read section-open. Exists because the base row inspection-rights grants exactly this and is BLOCKED for CA with no replacement - per the proof-of-absence standard an absence recorded only in a prose manifest is invisible to future canvasses. Caught on the extend screen's eyeball pass, not by the pattern screen. Note the practical consequence: a CA landlord wanting a mid-tenancy condition check must fit it to a s1954(a) purpose, and s1953(a)(1) means the tenant cannot agree otherwise.",
  },
  // Default & Termination
  {
    id: "edu-abandonment-damages-ca",
    title: "Damages when a tenant breaches and abandons",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "abandonment-damages",
    bodyText:
      "When a tenant breaches the lease and abandons, or the landlord ends the tenant's right to possession for breach, California lets the landlord recover unpaid rent earned before termination, the rent that would have been earned between termination and the award less whatever loss the tenant proves could reasonably have been avoided, and any other detriment proximately caused by the breach. Recovering rent for the balance of the term after the award is different: it is available only if the lease expressly provides for it, or if the landlord re-rented the property before the award and proves the re-rental was reasonable and in good faith. Interest on the pre-award amounts runs at the rate stated in the lease if lawful, otherwise at the legal rate. Making efforts to re-rent does not waive the landlord's right to damages.",
    notes: "CA: Civ. Code s1951.2, primary text supplied by Taylor 2026-09-19. Routed to education alongside the lease clause because the mechanics are litigation measures rather than lease terms. s1951.2(c)(1) is the OPT-IN: without the recital the landlord loses the post-award balance-of-term measure entirely unless it relet before award under (c)(2) - and (c)(2) recovery is itself 'subject to any limitations specified in the lease', so a badly drafted cap can bind the landlord on that route too. s1951.2(b): interest on (a)(1) and (a)(2) at the lease rate if lawful, else the legal rate; the (a)(3) amount is discounted at the FRB San Francisco discount rate PLUS 1 PERCENT and is not lease-adjustable. s1951.2(a)(2)-(3): the burden of proving avoidable loss is on the LESSEE, which is more landlord-favourable than a general duty-to-mitigate framing suggests. s1951.2(d): mitigation efforts do not waive damages. s1951.2(e) preserves the lessor's right to INDEMNIFICATION for pre-termination personal injury or property damage liability 'where the lease provides for such indemnification' - a sixth opt-in, but it sits in tension with s1953(a)(2) (waiver of future causes of action void) depending on whether the indemnity runs to third-party liability or to the tenant's own claims. NOT RESOLVED; flag before drafting an indemnity. s1951.4, cross-referenced at s1951.2(a) as the alternative remedy that keeps the lease in effect, has NOT BEEN READ - it is reported to depend on the lease permitting assignment and subletting subject to reasonable limitations, which would be a seventh opt-in. Read it before relying on either remedy.",
  },
  // Landlord Responsibilities
  {
    id: "edu-abuse-violence-protections-ca",
    title: "Abuse and violence: eviction bar, lock changes, confidentiality",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "abuse-violence-protections",
    bodyText:
      "A landlord may not terminate or refuse to renew a tenancy based on an act of abuse or violence against the tenant, the tenant's immediate family member, or a household member once the landlord has received qualifying documentation. There are two exceptions: where the perpetrator is a tenant in residence of the same unit, and where the perpetrator's words or actions have threatened the physical safety of other tenants, guests or invitees and the tenant continues to permit the perpetrator on the premises after a three-day notice requiring them not to. Where a person restrained by court order is a tenant of the same unit, the landlord must change the locks at the landlord's own expense within 24 hours of a written request accompanied by the order, and give the protected tenant a key; if the landlord does not, the tenant may change the locks and the landlord must reimburse the cost within 21 days. Information a tenant provides under these protections may not be disclosed to third parties without written consent or a court order. A landlord is not liable to other tenants for complying.",
    notes: "CA: CCP s1161.3 (amended AB 1756, eff. 2024-01-01) and Civ. Code s1941.6 (amended SB 1051, eff. 2025-01-01), primary text supplied by Taylor 2026-09-19. s1161.3(b)(2)(B) is the operative landlord route and it is procedural: the three-day notice requires the TENANT not to voluntarily permit or consent to the perpetrator's presence - it is not a notice to the perpetrator, and it only works if the perpetrator's conduct threatened others' physical safety. s1161.3(c) protects the landlord from other tenants' claims arising from compliance. s1161.3(d)(2) routes same-unit-perpetrator cases to CCP s1174.27, NOT READ. s1941.6 applies ONLY where the restrained person is a TENANT OF THE SAME UNIT - a different and narrower trigger than s1161.3. The 24-hour clock runs from the written request plus the order. s1941.6(c)(3) limits the self-help lock change to leases executed on or after 2011-01-01. s1941.6(e): the excluded person remains liable for rent under the lease. s1941.6(d) disapplies s789.3 liability - s789.3 READ 2026-09-19, see edu-self-help-eviction-ban-ca. The carve-out is necessary because excluding the restrained co-tenant by a lock change would otherwise be a willful lockout within s789.3(b)(1). Confidentiality duties sit in both s1161.3(e) and Civ. Code s1946.7(i). CCP s1174.27 READ 2026-09-19 (the same-unit-perpetrator procedure s1161.3(d)(2) routes to): where the court finds documentation of abuse or violence, the defendant raising the defence and other occupants not otherwise at fault are NOT guilty and owe NOTHING - no holdover damages, costs, termination fees or attorney's fees. Where another defendant is shown to be the perpetrator and guilty, the court MUST order a PARTIAL EVICTION of that person only, WITHOUT terminating the tenancy, and MUST order the landlord to change the locks; it may bar the perpetrator permanently, taking custody and visitation arrangements into account. A s1174.27 finding is inadmissible in any other proceeding.",
  },
  {
    id: "edu-fair-housing-classes-ca",
    title: "Protected classes and source-of-income rules",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "fair-housing-classes",
    bodyText:
      "California prohibits housing discrimination on the basis of race, color, religion, sex, gender, gender identity, gender expression, sexual orientation, marital status, national origin, ancestry, familial status, source of income, disability, veteran or military status, or genetic information, including a perception that a person has any of those characteristics or is associated with someone who does. Source of income includes federal, state and local public assistance and housing subsidies, expressly including Section 8 vouchers and HUD-VASH vouchers, so refusing to rent because an applicant holds a voucher is unlawful. Where there is a government rent subsidy, any financial or income standard must be based only on the portion of rent the tenant actually pays, and an applicant must be offered the option of supplying alternative evidence of ability to pay instead of a credit history. A landlord must also count the aggregate income of people residing together on the same basis as it would for married people.",
    notes: "CA: Gov. Code ss12955 (amended SB 267, eff. 2024-01-01) and 12927 (SB 222, eff. 2020-01-01), primary text supplied by Taylor 2026-09-19. Answers two canvass rows at once. THREE OPERATIONAL RULES most likely to be breached by a screening workflow rather than by lease text: s12955(n) aggregate-income rule; s12955(o)(1)(A) subsidy income standard keyed only to the TENANT'S PORTION - a 3x-the-rent rule applied to full contract rent is unlawful for a voucher holder; and s12955(o)(1)(B) the credit-history alternative, which requires giving reasonable time AND reasonably considering the alternative evidence. These bind the app's screening logic, not the lease. s12955(b) bars INQUIRY into most protected characteristics - note source of income is deliberately absent from the (b) list and s12955(p)(2) confirms asking about level or source of income is not itself discrimination. s12927(c)(2)(A): narrow exception for renting a portion of an OWNER-OCCUPIED single-family house to ONE roomer or boarder, and even then the s12955(c) advertising ban still applies. s12927(d): 'housing accommodation' expressly includes units offered through a HOSTING PLATFORM. s12927(c)(1) is the statutory basis for the reasonable accommodation and modification duties implemented by 2 CCR ss12176-12181. ENFORCEMENT, Gov. Code ss12980-12989.3 read 2026-09-19: administrative complaint within ONE YEAR (s12980(b)); a private civil action within TWO YEARS, tolled while the complaint is pending, and available whether or not a complaint was filed (s12989.1); actual AND PUNITIVE damages, injunctions and discretionary prevailing-party fees (s12989.2); Attorney General pattern-or-practice suits with civil penalties up to $50,000 for a first violation and $100,000 for each subsequent one (s12989.3). NEW from 2026-01-01 (SB 477): s12981(a)(2) requires ALL PARTIES to take part in the department's MANDATORY DISPUTE RESOLUTION, free of charge, before the department sues. Candidate 572.7: NO RESPONDENT ELECTION RIGHT - because CA housing cases are not heard administratively at all. The department prosecutes by CIVIL ACTION in superior court (s12981(a)(1)), so there is no administrative forum for a landlord to elect out of, unlike Ohio's s4112.055(A)(2).",
  },
  {
    id: "edu-tenant-harassment-ca",
    title: "Tenant harassment and immigration-status disclosure",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "tenant-harassment",
    bodyText:
      "California makes it unlawful for a landlord, for the purpose of influencing a tenant to vacate, to engage in conduct amounting to theft or extortion, to use or threaten force or menacing conduct interfering with the tenant's quiet enjoyment, to commit a significant and intentional violation of the entry statute, or to threaten to disclose information about the immigration or citizenship status of a tenant, occupant or anyone associated with them. A tenant who prevails may recover a civil penalty of up to $2,000 for each violation. Separately, it is unlawful to disclose such immigration or citizenship information to any immigration authority, law enforcement agency or government agency for the purpose of harassing or retaliating against a tenant, influencing them to vacate, or recovering possession. A court that finds such a disclosure must order statutory damages of between 6 and 12 times the monthly rent for each person whose status was disclosed, issue injunctive relief, and notify the district attorney.",
    notes: "CA: Civ. Code ss1940.2 and 1940.35 (both AB 291, eff. 2018-01-01), primary text supplied by Taylor 2026-09-19. s1940.2(a)(4) is the one that connects to the rest of this state's work: a SIGNIFICANT AND INTENTIONAL VIOLATION OF s1954 is statutory harassment, so misuse of the entry right is not merely a s1954 problem - it carries the s1940.2(b) $2,000-per-violation penalty. Cross-reference landlord-entry-ca and edu-no-periodic-inspection-ca. s1940.35 damages are MANDATORY and formula-based - 6 to 12 times monthly rent PER PERSON - plus attorney's fees to the prevailing party (s1940.35(e)) and waiver void (s1940.35(g)). s1940.35(h) lets a 501(c)(3) bring the injunctive action as a party. Among the most severe landlord penalties found in any state in this project. s1940.2(c) safe harbour: a good-faith oral or written warning about conduct that violates the lease, and ordinary explanation of the lease in the normal course of business, are not violations. Also relevant to retaliation: Civ. Code s1942.5(c)/(e) separately make threatening immigration reporting retaliatory conduct - three overlapping provisions on the same subject.",
  },
  // Default & Termination
  {
    id: "edu-abandoned-property-ca",
    title: "Disposing of personal property left after a tenancy",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California provides an optional procedure for personal property a tenant leaves behind after the tenancy ends and the premises are vacated. The landlord gives written notice to the former tenant and anyone else reasonably believed to own the property, describing it well enough to be identified, stating where it may be claimed, that reasonable storage costs may be charged, and a claim deadline at least 15 days after personal delivery or 18 days after mailing. The statute supplies notice forms that satisfy the requirement. Property must be left on the premises or stored safely with reasonable care. If it is not claimed, it must be sold at public sale after published notice, unless the landlord reasonably believes the total resale value is under $700, in which case the landlord may keep or dispose of it. Sale proceeds left over go to the county within 30 days and may be claimed by the former tenant for a year. A landlord who follows the procedure is protected from liability. No storage cost may be charged if the tenant reclaims property within two days of vacating.",
    notes: "CA: Civ. Code ss1980-1991 (Chapter 5, Disposition of Personal Property Remaining on Premises), primary text supplied by Taylor 2026-09-19. CLOSES A GAP THE PROJECT HAD NO ROW FOR IN ANY STATE. s1981(a): the procedure is OPTIONAL, but s1981(e) is the sting - if its requirements are not satisfied, the chapter does not protect the landlord at all and ordinary liability rules apply. The s1989 non-liability shield is the whole point of using it. PRESCRIBED FORMS at s1984 (former tenant) and s1985 (other owner), each 'in substantially the following form'; s1984(b) requires ONE OF TWO alternative closing statements depending on whether the property will be publicly sold or is believed worth under $700. Getting the wrong one in loses the shield. s1982: property the landlord reasonably believes to be LOST goes to police or sheriff first under ss2080 et seq., not through this chapter - and only if they refuse does this chapter apply. s1988(a) $700 threshold; s1988(c) surplus to the county within 30 days, claimable for one year. s1990(c): if stored on the premises, the storage cost is the FAIR RENTAL VALUE of the space; no cost at all if reclaimed within two days. s1983(a): records are presumed to be the TENANT'S. s1981(c) excludes manufactured homes, mobilehomes and commercial coaches; s1981(d) excludes animals; s1980.5 excludes commercial property but NOT self-storage units. s1991 permits combining this notice with a s1951.3 notice of belief of abandonment - s1951.3 since READ (2026-09-19), see edu-abandonment-belief-notice-ca. Note the two notices run on the SAME 15-day personal / 18-day mailed clock, which is what makes combining them practical. CCP s1174(e)-(m) is the post-writ route into this chapter. SERVICE MEMBERS, added 2026-09-19: Mil. & Vet. Code s409.1(b) bars foreclosing or enforcing ANY lien on a service member's property or personal effects - EXPRESSLY INCLUDING LIENS FOR STORAGE - during service and 120 days after, except on a prior court order. So recovering storage costs against a service member's left-behind property needs a court order first. Misdemeanor plus damages and fees.",
  },
  // Disclosures
  {
    id: "edu-death-on-premises-ca",
    title: "Death on the premises: the three-year rule",
    group: "Disclosures",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "death-on-premises",
    bodyText:
      "California law occupies the field on disclosing deaths that occurred on a property. An owner or agent is not required to disclose the occurrence of an occupant's death, or the manner of death, where the death occurred more than three years before the prospective tenant offers to rent, and is never required to disclose that an occupant was living with HIV or died of AIDS-related complications. The implication is that a death within the previous three years is treated as a material fact. An owner or agent is also not immunized for an intentional misrepresentation made in response to a direct question about deaths on the property.",
    notes: "CA: Civ. Code s1710.2, primary text supplied by Taylor 2026-09-19. NOTE it sits in Part 3, Obligations Imposed by Law - outside the landlord-tenant title. Sixth cross-chapter confirmation in CA. The section is drafted as a NON-disclosure safe harbour, not as a disclosure duty, so it states no affirmative requirement and the three-year duty is an inference from s1710.2(a)(1)(A)'s carve-out plus the general materiality standard. FLAGGED AS AN INFERENCE, NOT A HOLDING - the row is written as education and no lease clause is shipped. Confirm against case law before the app prompts for it. s1710.2(b): express field preemption over death and HIV-status disclosure. s1710.2(d): no immunity for an intentional misrepresentation in response to a DIRECT INQUIRY - so 'has anyone died here?' must be answered honestly even outside the three years. s1710.2(c) preserves all other physical-condition disclosure duties. 'Transferee' expressly includes a lessee or renter.",
  },
  // Default & Termination
  {
    id: "edu-eviction-record-access-ca",
    title: "Eviction court records are masked for 60 days",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "eviction-record-access",
    bodyText:
      "An unlawful detainer court file in California is not publicly accessible for the first 60 days after the complaint is filed. During that period the clerk may release records only to a party or their attorney, to someone who supplies the names of a plaintiff and a defendant plus the address including any unit number, to a resident of the premises who identifies a party or the case number and proves residency, or by court order on a showing of good cause. After 60 days the file opens if judgment has been entered for the plaintiff, and in a residential case based on a post-foreclosure claim only if judgment was entered for the plaintiff after a trial. The parties may also stipulate to bar access entirely. The clerk mails every named defendant a notice within 24 to 48 hours of filing, with legal-aid and lawyer-referral information.",
    notes: "CA: CCP s1161.2, primary text supplied by Taylor 2026-09-19 (amended AB 2304, eff. 2025-01-01). Answers the eviction-record-sealing canvass row - but the mechanism is MASKING AT FILING, not sealing after the fact, which is a materially different design from the sealing statutes found in ND and elsewhere. The default is CLOSED and access opens only on the s1161.2(a)(1)(E)-(G) conditions; a landlord who loses, or who settles, leaves a permanently non-public file. s1161.2(a)(2) also permits the parties to stipulate to bar access - a settlement lever worth knowing. s1161.2(d): an extra $15 filing fee on the plaintiff's first appearance. s1161.2(c) prescribes the clerk's notice content including a verbatim State Bar referral statement; that is the clerk's duty, not the landlord's, and no lease row is needed.",
  },
  // Landlord Responsibilities
  {
    id: "edu-balcony-inspection-ca",
    title: "Balcony and exterior elevated element inspections",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "Buildings with three or more multifamily dwelling units must have their exterior elevated elements - balconies, decks, porches, stairways, walkways and entry structures more than six feet above ground that rely on wood for support - inspected by a licensed architect, engineer, qualified contractor or certified building inspector hired by the owner. At least 15 percent of each type must be examined. The inspector delivers a written report within 45 days. Inspections were due by January 1, 2026 and are required every six years after that. Elements needing repair must be corrected by the owner under permit, within 120 days of permit approval, and anything posing an immediate threat requires immediate action including blocking access. An owner who does not comply within 180 days faces a civil penalty of $100 to $500 per day and a recordable building safety lien.",
    notes: "CA: H&S s17973, primary text supplied by Taylor 2026-09-19 (amended AB 130, eff. 2025-06-30). This is one of the two previously-unread entry grounds in Civ. Code s1954(a)(6) - now closed. Entry to comply with this article is a permitted purpose, so a landlord scheduling these inspections has a s1954 basis, subject to the notice requirements in landlord-entry-ca. THE DEADLINE HAS PASSED: first inspections were due 2026-01-01, so any CA landlord with 3+ units who has not done one is already exposed to the s17973(i)(2) penalty of $100-$500 PER DAY plus a building safety lien with judgment-lien priority. That makes this a live compliance item, not a future one. s17973(d)(1): reports kept for two inspection cycles and DISCLOSED AND DELIVERED TO THE BUYER on sale. s17973(n): does not apply to a common interest development. s17973(o): local governments may impose greater requirements - another municipal-layer deferral. s17973(e): buildings permitted on or after 2019-01-01 are inspected within six years of the certificate of occupancy.",
  },
  {
    id: "edu-criminal-history-screening-ca",
    title: "Criminal history in tenant screening",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California regulates how criminal history may be used in tenant screening. Blanket bans are unlawful: a policy excluding everyone with a criminal record, or with any prior conviction, misdemeanor or felony, is prohibited outright. A landlord may not seek, consider, use, or take adverse action based on an arrest that did not lead to conviction, on being questioned or detained, on participation in a diversion or deferred entry of judgment program, on an infraction, on a conviction that has been sealed, dismissed, vacated, expunged, pardoned or otherwise rendered inoperative, on a conviction for which a certificate of rehabilitation was granted, or on juvenile adjudications. Only convictions directly related to a substantial, legitimate, nondiscriminatory interest may be considered, judged by the nature and severity of the offense and how much time has passed. Whether a screening practice is defensible turns partly on whether it gives the applicant written notice of an opportunity to present mitigating information and actually considers it, checks the accuracy of the record, and delays the criminal history inquiry until after financial and other qualifications are verified. Mitigating information includes youth at the time of the offense, time elapsed, good tenant history, rehabilitation, and conduct arising from the applicant's status as a survivor of abuse or from a disability.",
    notes: "CA: 2 CCR ss12264-12271 (Civil Rights Council, Article 24, operative 2020-01-01), primary text supplied by Taylor 2026-09-19. CLOSES the tenant-screening gap flagged from s1950.1(f) - an area the canvass had no row for in ANY state. s12269(a)(5) bans BLANKET BANS by name and gives four examples, so the most common screening policy in the industry is per se unlawful in CA. s12269(a)(1)-(4) list categories that may not be sought OR considered at all - note 'SEEK' is prohibited, so merely running a report that surfaces them is exposure, not just acting on them. Narrow proviso: if the APPLICANT volunteers such information as mitigating evidence, it may be considered. s12266(d)(4) is the structural one for the product: delaying criminal history inquiry until AFTER financial and other qualifications are verified is a factor in whether a less discriminatory alternative was feasible. That is a workflow-ordering rule, not a lease term, and it interacts with the s1950.6(c)(2) screening-process choice and the s1950.1 reusable-report regime. s12266(e) mitigating information expressly includes conduct arising from SURVIVOR STATUS (DV, sexual assault, dating violence, stalking) and conduct arising from a DISABILITY that could be mitigated by a reasonable accommodation - linking this article to dv-lease-termination-ca and to ss12176-12181. s12269(b): the seven-year look-back permitted by Civ. Code s1785.13(a)(6) is a ceiling, not a safe harbour - a court may find a SHORTER look-back was the feasible alternative. s12270(a): complying with a federal law that REQUIRES consideration (sex offender public housing ineligibility, meth manufacture) is an affirmative defence. s12271: local ordinances may be more protective and are not displaced. s12268(b): advertising a lawful screening policy is not itself unlawful. ss12005(f), 12005(k), 12062(c)-(d) and Gov. Code s12955.8 NOT READ.",
  },
  {
    id: "edu-rent-demand-bar-ca",
    title: "When a landlord may not demand or collect rent at all",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California bars a landlord from demanding rent, collecting rent, issuing a notice of rent increase, or issuing a three-day notice to pay rent or quit where four conditions all exist. The dwelling substantially lacks one of the standard habitability characteristics, violates Health and Safety Code section 17920.10, or is substandard under section 17920.3 to an extent that endangers life, limb, health, property, safety or welfare. A public officer responsible for enforcing housing law has inspected the premises and notified the landlord in writing of the obligation to abate or repair. The conditions have gone unabated for 35 days beyond service of that notice without good cause. And the conditions were not caused by the tenant. A landlord who violates this is liable for actual damages plus special damages of between $100 and $5,000, and the prevailing party recovers attorney's fees and costs. The court may also order the conditions abated and retain jurisdiction until they are.",
    notes: "CA: Civ. Code s1942.4, primary text supplied by Taylor 2026-09-19. SHOULD HAVE SURFACED EARLIER IN THIS PASS - it is the most consequential habitability remedy in the CA set and it was missed until the canvass forced the question. It bars the landlord's core economic act, not merely the eviction. ALL FOUR CONDITIONS MUST COEXIST, and condition (2) is the practical gate: it requires an INSPECTION AND WRITTEN NOTICE BY A PUBLIC OFFICER, so a tenant's own complaint does not trigger the bar. Condition (3) runs 35 DAYS from service, and s1942.4(a)(3) makes service complete ON DEPOSIT IN THE MAIL, not receipt. s1942.4(d): the tenant need NOT exhaust any other remedy first - so this sits alongside s1942 repair-and-deduct rather than after it, and s1942.4(f) makes it cumulative. s1942.4(e): available in small claims. DIRECT PRODUCT CONSEQUENCE: a three-day notice issued while this bar applies is void ab initio, so the legal tracker's notice generator needs a gate here, not just the CCP s1161(2) content checks - cross-refer edu-three-day-notice-ca. Also note s1942.4(a)(1) cites H&S s17920.10, the OTHER incorporation in s1941.1(a) - READ 2026-09-19, see edu-lead-hazards-ca. A unit with lead hazards at or above the s17920.10(c) thresholds satisfies condition (a)(1) of the bar, and repair work disturbing lead paint without containment can itself create one. s1942.4(f) carve-out: the section does not bind a landlord pursuing Ellis Act rights under Gov. Code s7060 et seq. - NOT READ. FEE EXPOSURE, CCP s1174.21 read 2026-09-19: a landlord who brings a NONPAYMENT unlawful detainer while liable for a s1942.4 violation is liable for the TENANT'S attorney's fees and costs. So filing through the bar costs the landlord the tenant's fees as well as losing the case.",
  },
  // Default & Termination
  {
    id: "edu-fee-shifting-ca",
    title: "Attorney-fee clauses are reciprocal by operation of law",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "fee-shifting",
    bodyText:
      "In California, if a lease provides that attorney's fees incurred to enforce it will be awarded to one party or to the prevailing party, the party who actually prevails is entitled to reasonable fees whether or not the lease names them. A one-sided fee clause therefore operates in both directions, and any provision waiving that rule is void. The fee provision is read as applying to the whole contract unless both parties were represented by counsel in negotiating and executing it and the lease says so. The court decides who prevailed, may find that nobody did, and there is no prevailing party at all where the action was voluntarily dismissed or dismissed under a settlement.",
    notes: "CA: Civ. Code s1717, primary text supplied by Taylor 2026-09-19. CONFIRMS the reasoning already relied on in three places - the extend manifest's decision that CA uses the full default-by-tenant row rather than the Ohio-style default-by-tenant-ks-ne variant, and the notes on default-by-tenant and s1942.5(i). Until now that reciprocity was asserted from the section number alone; it is now read. s1717(a): reciprocity is automatic and the anti-waiver sentence is unconditional - 'any provision in any such contract which provides for a waiver of attorney's fees is void'. s1717(b)(2) is the limb landlords misjudge: VOLUNTARY DISMISSAL OR SETTLEMENT MEANS NO PREVAILING PARTY, so a landlord who settles an unlawful detainer recovers no fees under the clause however favourable the settlement. Worth surfacing in the legal tracker before a settlement decision. The whole-contract rule in s1717(a) means a narrowly drafted fee clause aimed at one covenant is read across the entire lease unless the dual-counsel condition is met and RECITED - which essentially never happens in residential leases. Interacts with Civ. Code s1953(a)(4) (waiver of procedural rights in litigation void) - that relationship is NOT resolved here.",
  },
  // Compliance & Prohibited Terms
  {
    id: "edu-unconscionability-ca",
    title: "Unconscionable lease clauses",
    group: "Compliance & Prohibited Terms",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "unconscionability",
    bodyText:
      "A California court that finds a contract or any clause of it was unconscionable when it was made may refuse to enforce the contract, enforce the rest of it without the unconscionable clause, or limit the clause's application to avoid an unconscionable result. Where unconscionability is claimed or appears, the parties must be given a reasonable opportunity to present evidence about the clause's commercial setting, purpose and effect.",
    notes: "CA: Civ. Code s1670.5, primary text supplied by Taylor 2026-09-19. NOTE this is s1670.5, NOT s1670.50 (buyer-broker representation agreements) - the two differ by a trailing zero and the wrong one was supplied first. See the cross-body citation-ambiguity topic. s1670.5 is a general contracts doctrine, not a landlord-tenant provision, and it supplies a REMEDIAL FLEXIBILITY the specific voiding statutes do not: where s1953, s1942.1, s1632(l) or 2 CCR s12180(a)(3) make a provision void outright, s1670.5(a) lets a court instead sever the clause or merely LIMIT its application. It is a backstop for clause types CA has not specifically addressed, not a substitute for the specific bars. s1670.5(b) is procedural and matters for drafting evidence: the commercial setting, purpose and effect are expressly in issue, which is where an adhesion-contract argument about a standard-form lease would run. Case law is where the substance of CA unconscionability doctrine lives; none read.",
  },
  // Pets
  {
    id: "edu-service-animal-misrepresentation-ca",
    title: "Criminal penalty for faking a service dog",
    group: "Pets",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "In California it is a misdemeanor to knowingly and fraudulently represent yourself, verbally or in writing, as the owner or trainer of a dog licensed, qualified or identified as a guide, signal or service dog. The penalty is up to six months in county jail, a fine of up to $1,000, or both.",
    notes: "CA: Pen. Code s365.7, primary text supplied by Taylor 2026-09-19. Answers the canvass row, but the SCOPE IS NARROW and a landlord should not be told otherwise: it reaches only CANINES, and only guide, signal or SERVICE dogs as defined in Pen. Code s365.5(d)-(f) and Civ. Code s54.1(b)(6). It does NOT reach misrepresentation about a SUPPORT animal, which is the category landlords most often suspect - and support animals are precisely where 2 CCR s12185(c)(2)'s online-certification presumption operates instead. The two mechanisms cover different animals and should not be conflated. It is also a criminal provision, so it is not a landlord remedy: the landlord's route remains the s12178/s12185 documentation process, not a prosecution. Pen. Code s365.5 and Civ. Code s54.1 NOT READ. Pen. Code s365.5 READ 2026-09-19: s365.5(c) makes it a MISDEMEANOR, fine up to $2,500, to prevent or interfere with a disabled person's rights under the section - but those rights, at (b), are admittance to 'accommodations, advantages, facilities... hotels, lodging places, places of public accommodation... and other places to which the GENERAL PUBLIC IS INVITED'. A private residential tenancy is not a place to which the general public is invited, so on its text s365.5 reaches HOTELS AND LODGING but NOT ordinary rental housing. It is also CANINE-ONLY and reaches only guide, signal and service dogs - never support animals. So California has NO criminal penalty for a landlord denying an assistance animal in a residential tenancy; the remedy runs through FEHA and 2 CCR s12176 et seq. Textual conclusion; Civ. Code s54.1, the housing-access provision s365.7 cross-refers to, remains unread. Civ. Code s54.1 READ 2026-09-19 (Disabled Persons Act). s54.1(b)(6)(A): refusing to rent to, or to let a tenant keep, a GUIDE, SIGNAL OR SERVICE DOG is a denial of equal access to housing - even where the landlord bars dogs generally (s54.1(b)(5)). s54.1(b)(6)(B): the lease MAY reasonably regulate the dog's presence outside its duties, and the tenant stays liable for proven damage. Like the Penal Code sections, s54.1 is DOG-ONLY; SUPPORT animals rest on FEHA and 2 CCR s12185 alone. s54.1(b)(3)(A): modifications at the tenant's expense may be conditioned on RESTORATION, and NO ADDITIONAL SECURITY may be required - though an escrow for restoration costs may be negotiated. s54.1(d): any ADA violation is also a s54.1 violation. Remedies are in s54.3, NOT READ.",
  },
  // Landlord Responsibilities
  {
    id: "edu-relocation-benefits-ca",
    title: "Relocation benefits during habitability repairs",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "relocation-benefits",
    bodyText:
      "Where a California enforcement agency has cited a building and the court finds conditions substantially endangering health and safety, and the owner's repairs or the conditions themselves significantly affect safe and sanitary use so that a tenant cannot safely remain, the owner must provide or pay relocation benefits. These cover actual reasonable moving and storage costs, including transporting, packing and insuring the tenant's property, replacing property lost or damaged in the move, and reconnecting utilities and equipment. On top of that, relocation compensation equals the difference between the contract rent and the HUD fair market rent for a comparable unit in the area, for the period of repair, up to 120 days. A tenant substantially responsible for causing the conditions receives nothing. The owner must also offer each relocated tenant the first right to occupancy in writing by certified mail before renting to anyone else. If a receiver is appointed, the owner is enjoined from collecting rent at all.",
    notes: "CA: H&S s17980.7, primary text supplied by Taylor 2026-09-19 (amended SB 1465, eff. 2025-01-01). Answers the relocation canvass row. Note the TRIGGER IS ENFORCEMENT-DRIVEN, not tenant-driven: it follows a s17980.6 order or notice and, for the (d) benefits, a court finding - so it is not a self-executing duty the moment a unit becomes uninhabitable. s17980.7(d)(3)(B)(i): compensation is the CONTRACT RENT vs HUD FAIR MARKET RENT DIFFERENTIAL for a comparable unit, capped at 120 DAYS - a formula the app cannot compute without the HUD FMR table, so it is a lookup dependency, not a stored constant. s17980.7(d)(5): the first-right-to-occupancy offer must be in writing by first-class CERTIFIED mail, and the tenant has 10 days to respond - but the duty lapses entirely if the tenant never gave a relocation address. s17980.7(c)(3): on appointment of a receiver the owner AND the owner's agent are ENJOINED FROM COLLECTING RENTS - a second and more drastic rent-collection bar alongside Civ. Code s1942.4. s17980.7(e) IS THE CROSS-LINK WORTH KNOWING: initiating a proceeding or entering judgment under this section is deemed a 'proceeding' or 'judgment' under Civ. Code s1942.5(a)(4)-(5), so it starts a 180-day RETALIATION window - see edu-retaliation-ca. s17980.7(c)(11) prevailing-party fees; (b) loss of state tax deductions for interest, taxes, depreciation and amortization on the cited structure; (h) Ellis Act carve-out. ss17980, 17980.6 and 17995 NOT READ.",
  },
  // Rent & Payment
  {
    id: "edu-double-letting-ca",
    title: "Double letting of a room suspends all rent in the building",
    group: "Rent & Payment",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "double-letting",
    bodyText:
      "California provides that a person who hires part of a room as a dwelling is entitled to the whole room, regardless of any agreement to the contrary. If a landlord lets a room as a dwelling to more than one family, the first person to whom any part of it was let is entitled to possession of the whole room for the agreed term, and every tenant in the building under the same landlord is relieved of all obligation to pay rent for as long as the double letting continues.",
    notes: "CA: Civ. Code s1950, read section-open 2026-09-19. Answers the double-letting canvass row, and the remedy is far more severe than the row anticipated: it is not abatement for the affected tenant, it suspends the rent obligation of EVERY TENANT IN THE BUILDING under the same landlord while the double letting continues. Enacted 1872 and never amended. Unusually, it overrides contrary agreement by its own terms ('notwithstanding any agreement to the contrary'), so it does not depend on s1953. No case law read; the practical scope of 'lets a room as a dwelling for more than one family' is untested here.",
  },
  // Landlord Responsibilities
  {
    id: "edu-screening-abuse-protections-ca",
    title: "Screening: four things a landlord may not hold against an applicant",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "screening-abuse-protections",
    bodyText:
      "California bars a landlord from taking adverse action in tenant screening based on any of four things: an alleged breach of a prior lease that stemmed from an act of abuse or violence, where the applicant is not alleged to have committed it; the applicant having previously requested a lock change after abuse or violence, whether or not the request was granted; the applicant, or an immediate family or household member, having been a victim of abuse or violence; or the applicant or a guest having previously summoned law enforcement or emergency assistance for a victim of abuse, a victim of crime, or a person in an emergency. Adverse action includes both denying the application and approving it on terms less favourable than those advertised. A landlord who violates this is liable for actual damages plus statutory damages of $100 to $5,000.",
    notes: "CA: Civ. Code s1946.9, added by SB 1051 (Stats. 2024 ch. 75), eff. 2025-01-01. Sits alongside 2 CCR ss12264-12271 as the second distinct screening-restriction regime in CA, and it is not about criminal history at all. s1946.9(d)(2)(B) is the limb most likely to catch a compliant-looking workflow: ADVERSE ACTION INCLUDES APPROVING the application on terms 'different and less favourable' than any written notice, statement or advertisement - so a higher deposit, a co-signer requirement or a shorter term imposed on one of these four grounds is a violation even though the applicant was accepted. s1946.9(a)(1) and (a)(3): where the landlord asks for documentation, it MUST accept any of the forms listed in s1941.5(d), which includes the catch-all 'any other form of documentation that reasonably verifies that the abuse or violence occurred, INCLUDING A SIGNED STATEMENT FROM THE ELIGIBLE TENANT'. A landlord cannot demand a police report or restraining order. Connects to dv-lease-termination-ca (s1946.7), edu-abuse-violence-protections-ca (ss1161.3, 1941.5, 1941.6) and emergency-assistance-right-ca (s1946.8) - the four together form a single statutory scheme, and s1946.9 is the screening-stage end of it.",
  },
  {
    id: "edu-rent-reporting-offer-ca",
    title: "Mandatory offer of positive rent reporting",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "rent-reporting-offer",
    bodyText:
      "California requires most residential landlords to offer each tenant the option of having positive rental payment information reported to a consumer reporting agency. For leases entered into on or after April 1, 2025, the offer must be made at the time of the lease and at least once annually after that. The written election must state that reporting is optional, identify each agency, state any fee, explain how to opt in and out, note that a tenant who opts out cannot resume for six months, and include a signature block. A landlord may charge no more than the actual cost or $10 per month, whichever is less, and nothing if there is no actual cost. Non-payment of that fee cannot be reported, cannot be cause for termination, and cannot be deducted from the security deposit. The duty does not apply to a landlord of a building with 15 or fewer units unless the landlord owns more than one building and is a REIT, a corporation, or an LLC with a corporate member.",
    notes: "CA: Civ. Code s1954.07, added by AB 2747 (Stats. 2024 ch. 279), eff. 2025-01-01, offers due from 2025-04-01. A landlord DUTY, not merely a permission - the library has nothing like it in any state. s1954.07(l): only POSITIVE information may be reported - complete, timely payments. Late or missed payments are expressly excluded, so this cannot be used as a collection lever. s1954.07(g)(2): an amount tendered toward rent may NOT be applied or credited to the reporting fee - which cuts directly against the base application-of-payments row's fees-first ordering. Screen that row for CA. s1954.07(k): a tenant who opts in does not forfeit ss1941-1942 rights, and a lawful repair-and-deduct or withholding is NOT a late payment for reporting purposes, provided the tenant notifies before rent is due. s1954.06 is a parallel, earlier and stricter regime for ASSISTED HOUSING developments (from 2021-07-01, reporting ALL payments including late ones where applicable) - read, not separately rowed. Small-landlord exemption at s1954.07(j) mirrors s1954.06(j).",
  },
  // Default & Termination
  {
    id: "edu-abandonment-belief-notice-ca",
    title: "Notice of belief of abandonment",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "Where rent has been due and unpaid for at least 14 consecutive days and the landlord reasonably believes the tenant has abandoned the property, the landlord may serve a notice of belief of abandonment. The statute supplies the form. The notice must specify a termination date at least 15 days after personal service or 18 days after mailing, and the lease terminates on that date unless the tenant gives written notice before then stating an intent not to abandon and an address for service by certified mail. The property is not deemed abandoned if the rent was not in fact 14 days overdue, if the landlord's belief was not reasonable, if the tenant gave the required notice, or if the tenant paid all or part of the overdue rent in the relevant window. Knowing that the tenant left personal property behind does not by itself make the belief unreasonable.",
    notes: "CA: Civ. Code s1951.3, read section-open 2026-09-19 (amended AB 2847, eff. 2019-01-01). s1951.3(a) limits it to NON-commercial property; s1951.35 is the commercial twin with a different trigger. PRESCRIBED FORM at s1951.3(e), 'in substantially the following form'. s1951.3(h) is the trap: this notice DOES NOT satisfy CCP ss1161 or 1162, and giving it does not preclude or replace a pay-or-quit notice. A landlord who serves only this and then files an unlawful detainer has no predicate notice. Connects two regimes already rowed: s1951.3 terminates the lease for s1951.2 damages purposes, and Civ. Code s1991 permits combining this notice with the s1983 abandoned-property notice in a single document - see edu-abandoned-property-ca and edu-abandonment-damages-ca. s1951.3(f)(2) expressly rejects the inference landlords most often draw: leaving possessions behind does not, of itself, justify a finding that abandonment was not reasonably believed.",
  },
  {
    id: "edu-social-security-defense-ca",
    title: "Social Security hardship defence to eviction",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "Until January 20, 2029, a California tenant facing an unlawful detainer for nonpayment of rent may assert a Social Security hardship defence by showing that the household's usual Social Security benefits were terminated, delayed or reduced through no fault of the tenant because of federal government action or inaction, and that the interruption prevented payment of the rent claimed. If the tenant proves both, the court must stay the action until 14 days after benefits are restored or six months after the stay, whichever is earlier. The tenant must then pay all past-due rent or agree a payment plan within 14 days of restoration, and if they do, the court must restore the tenancy and dismiss the action or set aside the judgment.",
    notes: "CA: Civ. Code s1946.3, the Social Security Tenant Protection Act of 2025, added by AB 246 (Stats. 2025 ch. 337), EFFECTIVE 2026-01-01, SUNSETS 2029-01-20. Legal-watch item: a dated repeal clause, and the sunset date is unusual - January 20 rather than January 1 - which a date-matching bill tracker keyed to year-start sunsets would miss. Applies ONLY to nonpayment-of-rent unlawful detainers (s1946.3(h)). Does NOT relieve the tenant of the rent (s1946.3(e)(1)); it defers, it does not forgive. The stay is MANDATORY on proof, not discretionary. Routed to the legal tracker rather than lease text - it bites at the pleading stage. Joins s1946.7, s1946.8, s1161.3 and 2 CCR s12176(f)(8) as a fifth statutory affirmative defence to unlawful detainer found in CA. Judicial Council forms due by 2027-01-01 (s1946.3(g)).",
  },
  // Landlord Responsibilities
  {
    id: "edu-habitability-presumption-ca",
    title: "When a habitability breach is presumed in an eviction",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "In an unlawful detainer action, California presumes that the landlord has breached the habitability requirements where the dwelling substantially lacks a standard habitability characteristic, is substandard under the Health and Safety Code, or contains lead hazards; a housing enforcement officer has inspected and notified the landlord in writing to repair; the conditions remain unabated 60 days after that notice without good cause; and the tenant did not cause them. The presumption shifts the burden of producing evidence to the landlord. A tenant who cannot establish all four conditions may still raise any other habitability defence.",
    notes: "CA: Civ. Code s1942.3, read section-open 2026-09-19. Same four-condition structure as s1942.4, with two differences worth keeping straight: the clock is 60 DAYS from ISSUANCE of the notice, where s1942.4 is 35 DAYS from SERVICE (complete on mailing); and s1942.3 creates an EVIDENTIARY PRESUMPTION in an eviction rather than barring the landlord's rent demand outright. A property can therefore reach the s1942.4 bar weeks before the s1942.3 presumption arises. s1942.3(a)(1) also names LEAD HAZARDS under H&S s17920.10 expressly - the third CA provision to cite s17920.10, now READ - see edu-lead-hazards-ca. s1942.3(c): applies to leases entered into or renewed on or after 1986-01-01. UD PROCEDURE, CCP s1174.2 read 2026-09-19: where a tenant raises habitability in a nonpayment case and the court finds a SUBSTANTIAL breach (failure to meet building and housing code standards materially affecting health and safety), the court must fix the reasonable rental value of the unit in its untenantable state, DENY POSSESSION and make the TENANT the prevailing party on paying that adjusted rent within 5 days, may order repairs with continuing jurisdiction, and must cap the rent at that value until repairs are done. The jury right is preserved (s1174.2(d)).",
  },
  // Notices & General
  {
    id: "edu-disaster-displaced-guests-ca",
    title: "Disaster-displaced hotel and short-stay guests",
    group: "Notices & General",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "Until January 1, 2031, a guest staying in a hotel, motel or compliant short-term lodging because a declared disaster substantially damaged, destroyed or made uninhabitable their home is not treated as a tenant, and their stay does not become a tenancy for eviction purposes, until they have stayed 270 days. Before or at check-in for a stay exceeding 30 consecutive days, the operator must give the statutory notice in at least 12-point type and a confirmation form on which the guest indicates whether they are disaster-displaced. Once such a guest has stayed more than 30 days, the operator must give 72 hours' written notice before requiring them to leave, unless the guest has failed to pay, interfered with other guests, damaged or threatened to damage property, or poses a risk of harm.",
    notes: "CA: Civ. Code s1954.071, added by AB 299 (Stats. 2025 ch. 531), EFFECTIVE 2025-10-10 as an urgency measure, SUNSETS 2031-01-01. An EXPRESS EXCEPTION to the s1940(b)/R&T s7280 30-day line recorded at edu-tenancy-scope-ca: for disaster-displaced guests the line moves from 30 days to 270. Cross-noted there. Relevant to short-stay operators rather than landlords, but a property-management product serving both should know it. Prescribed notice and a prescribed two-option confirmation form, both verbatim at s1954.071(c)-(d). A SEVENTH TYPE-SIZE FLOOR in CA (12-point, s1954.071(c)). If the guest refuses to select either statement the operator may rely on other reasonable information, or limit or refuse the stay.",
  },
  // Landlord Responsibilities
  {
    id: "edu-other-landlord-facilities-ca",
    title: "Further landlord-supplied facilities",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "Beyond the standard habitability list, a California landlord must keep floors, stairways and railings in good repair; provide a locking mail receptacle for each unit in a residential hotel; and install at least one usable telephone jack and keep the inside telephone wiring in good working order, meeting current electrical code, without restricting the telephone utility's access to its network facilities.",
    notes: "CA: Civ. Code ss1941.1(a)(8)-(9) and 1941.4, read section-open 2026-09-19. The supplied s1941.1 extract earlier in this pass stopped at (a)(7); the full current text adds (a)(8) floors, stairways and railings, (a)(9) residential-hotel mail receptacles, and (a)(10)-(11) stove and refrigerator (rowed separately at stove-refrigerator-ca). Every CA row that summarised the s1941.1 list as seven characteristics is now short by four. s1941.4's inside-wiring duty runs to the demarcation point set by the telephone corporation under PUC orders. Separately, s1941.7 provides that no s1941/s1942 duty to repair MOLD under H&S s17920.3(a)(13) arises until the landlord has NOTICE, or where the tenant is in violation of s1941.2 - cross-noted at edu-mold-disclosure-contingency-ca.",
  },
  // Disclosures
  {
    id: "edu-lead-hazards-ca",
    title: "Lead hazards as a habitability violation",
    group: "Disclosures",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California treats lead hazards as a habitability violation, separately from and in addition to the federal lead-based paint disclosure rule. Any dwelling unit, or any portion of a building or its premises, that contains lead hazards is deemed in violation of the state housing law. Lead hazards means deteriorated lead-based paint, lead-contaminated dust, lead-contaminated soil, or disturbing lead-based paint without containment, at levels likely to endanger the health of occupants or the public. Deteriorated paint and paint disturbed without containment count only where the affected area reaches at least two square feet in any one interior room, twenty square feet on exterior surfaces, or ten percent of the surface of a small component such as a window sill, baseboard or trim - unless a smaller area is associated with a person whose blood lead level is 10 micrograms per deciliter or higher, in which case the smaller area counts. Because a unit containing lead hazards is untenantable, the tenant's habitability remedies apply, and repair or renovation work that disturbs lead-based paint without containment can itself create a violation.",
    notes: "CA: H&S s17920.10, primary text supplied by Taylor 2026-09-19 (added Stats. 2002 ch. 931, eff. 2003-01-01). CLOSES A DEPENDENCY CITED BY THREE CA PROVISIONS: Civ. Code s1941.1(a) incorporates it (making a lead-hazard unit untenantable), s1942.4(a)(1) cites it for the rent-demand bar, and s1942.3(a)(1) cites it for the eviction presumption. CORRECTS THE CANVASS: the lead-based-paint row had been answered 'Federal, applies. No CA-specific overlay located.' That was WRONG. The federal rule is a pre-1978 DISCLOSURE duty; CA adds a HABITABILITY STANDARD with quantified thresholds that applies regardless of construction date, and it routes into s1942 repair-and-deduct, the s1942.4 rent-demand bar and the s1942.3 presumption. The two regimes are complementary and must not be collapsed. I answered the canvass row from the federal side only because s17920.10 was unread at the time - the error shape is answering from the provision you have rather than the one that governs. OPERATIONAL TRAP: 'disturbing lead-based paint without containment' is itself a lead hazard - so a landlord's own repair, renovation or turnover work in a unit with lead-based paint can CREATE a habitability violation, and with it the s1942.4 bar on collecting rent. Relevant to the maintenance-tracking module. THRESHOLDS at s17920.10(c) apply only 'in the absence of new regulations' - they are a default, not a fixed rule. s17920.10(d) overrides them where a smaller area is associated with a blood lead level of 10 micrograms per deciliter or more; that figure is fixed in the statute and is not tied to any current public-health reference value - whether it lags current guidance was NOT researched. ADMINISTRATIVE-CODE DEPENDENCY, Instruction 16: definitions and levels come from 17 CCR Chapter 8, s35001 et seq. (Department of Health Services, now CDPH) - NOT READ. s17920.10(e) defers any new definitions at least three months after OAL approval, then to the next January 1 or July 1. So the legal-watch workflow needs a CDPH rulemaking watch in addition to the Civil Rights Council one - a SECOND state agency whose regulations govern CA landlord obligations. PARTIAL READ OF 17 CCR CHAPTER 8, 2026-09-19: s35001, supplied by Taylor, defines only 'ABATEMENT' - 'any set of measures designed to reduce or eliminate lead hazards or lead-based paint... but does NOT include containment or cleaning.' That distinction matters for this row: s17920.10(a) makes 'disturbing lead-based paint WITHOUT CONTAINMENT' a hazard, and s35001 confirms containment and cleaning are a separate category from abatement - so a landlord who contains and cleans properly during ordinary repair work is not thereby 'abating', and one who disturbs paint without containment has created a hazard even if no abatement was intended. FLAG, NOT VERIFIED: the chapter is titled 'Accreditation, Certification and Work Practices for Lead-Based Paint and Lead Hazards', which indicates it regulates WHO may perform lead work and HOW - potentially a certified-worker requirement for abatement in CA rental property. That is an inference from the heading alone; no substantive work-practice or certification section has been read. Do not tell a landlord certification is required on the strength of this. STILL UNREAD: the Article 1 definitions s17920.10(b) actually defers to - 'lead-based paint', 'deteriorated lead-based paint', 'lead-contaminated dust', 'lead-contaminated soil', 'containment' and 'lead hazard' - which carry the dust and soil LEVELS. Their section numbers were not assumed. The s17920.10(c) paint-area thresholds already in this row are statutory and do not depend on them. Amendment history shows s35001 last touched 2008 (NOTE only) - the chapter appears stable. 17 CCR s35033 READ 2026-09-19: 'LEAD-BASED PAINT' means paint or other surface coatings with lead EQUAL TO OR ABOVE 1.0 mg/cm2 OR 0.5% BY WEIGHT. That definition feeds both 'deteriorated lead-based paint' and 'disturbing lead-based paint without containment' - the two s17920.10 hazards measured by the statutory area thresholds already in this row - so it closes the question that matters for the product. The DUST and SOIL levels (the other Article 1 definitions) remain unread by decision: they are laboratory thresholds the app will not interpret.",
  },
  // Rent & Payment
  {
    id: "edu-no-clra-rent-pricing-ca",
    title: "The consumer all-in pricing rule does not reach rent",
    group: "Rent & Payment",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "clra-rent-pricing",
    bodyText:
      "California's general all-in pricing rule under the Consumers Legal Remedies Act, which makes it unlawful to advertise or offer a price that omits mandatory fees, applies to transactions for the sale or lease of goods or services to a consumer. A residential tenancy is neither: the Act defines goods as tangible chattels and services as work, labor and services, and a lease of real property is the hiring of land, not a chattel or a service. On the statute's text, that rule does not govern how rent is advertised. California instead regulates specific rental charges directly - screening fees, check-payment fees, notice-service fees, accommodation fees and separately listed rent concessions - and those rules apply regardless.",
    notes: "CA: CONFIRMED ON THE TEXT 2026-09-19, from Civ. Code s1761 read with s1770(a). s1770(a) reaches acts 'in a transaction intended to result or that results in the sale or lease of GOODS OR SERVICES to any consumer'. s1761(a) defines 'goods' as TANGIBLE CHATTELS - real property is not a chattel, and the only real-property reference in (a) is to goods that become AFFIXED to real property, which confirms the drafters treated land and chattels as distinct. s1761(b) defines 'services' as 'work, labor, and services', which a tenancy - a 'hiring' of real property under s1925 - is not. So s1770(a)(29) does not reach advertised RENT. Written as a row per the proof-of-absence standard, because the earlier canvass answer left this unresolved and a finding recorded only in prose is invisible. EVIDENTIARY LIMIT: this is a TEXTUAL conclusion. Case law on whether the CLRA reaches residential leases was NOT read, and a court could treat genuinely separable services bundled with a tenancy - a paid cleaning or concierge service, say - differently from the rent. Flagged, not resolved. Nor was any RENTAL-SPECIFIC fee-transparency statute outside the CLRA searched for; this row establishes only that the CLRA route is closed. What CA does regulate directly, all rowed: s1947.12(a)(1) discounts and concessions listed separately in the lease; s1950.6 screening fees; s1947.3(b) no check-payment fee; ss1946(b), 1946.1(i) and CCP s1161(6) no notice-service fees; 2 CCR s12180(a)(1) no accommodation fees; s1954.07(g) rent-reporting fee cap. GROUP NORMALISED 2026-09-19: 'Rent & Fees' -> 'Rent & Payment' (session drift; 12 canonical groups are used by all nine states).",
  },
  // Compliance & Prohibited Terms
  {
    id: "edu-exculpation-case-law-ca",
    title: "Exculpatory clauses in residential leases: the case law",
    group: "Compliance & Prohibited Terms",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "exculpation-case-law",
    bodyText:
      "The California Supreme Court has held that a residential lease affects the public interest, so a clause exempting a landlord from liability for its own future negligence is invalid. More recently, the Court held that no contract may release a party from liability for violating a statutory duty: the older public-interest test applies only to releases of ordinary common-law negligence. Because most of a California landlord's duties to tenants are statutory - habitability, locks, smoke alarms, building conditions, balcony inspections - a lease release cannot reach a claim that one of those duties was breached. A narrow exception recognised by a court of appeal, for injuries from using an on-site recreational amenity such as an exercise facility, survives only for ordinary negligence claims, not for claims that a statutory duty was violated.",
    notes: "CA: CASE LAW, read at opinion-snippet level 2026-09-19. RESOLVES the open Tunkl question. HENRIOULLE v. MARIN VENTURES, INC. (1978) 20 Cal.3d 512: applying the six-factor Tunkl v. Regents (1963) 60 Cal.2d 92 public-interest test, the Supreme Court held exculpatory clauses in residential leases INVALID, expressly rejecting the older Barkett v. Brucato line that treated landlord-tenant as outside the public interest. Opinion text viewed via Justia and CourtListener. THIS STRENGTHENS, NOT WEAKENS, THE EXTEND-SCREEN BLOCKS. My earlier concern was that Civ. Code s1668 alone does not reach ordinary negligence untouched by the public interest - Henrioulle answers that residential leases ARE in the public interest, so ordinary-negligence exculpation fails too, independently of s1953(a)(5). The removals on tenants-property-insurance-ca, parking-ca and storage-space-ca are confirmed on a second, common-law ground. services-utilities-provided-ca survives because its surviving disclaimer reaches only causes BEYOND the landlord's reasonable control, which is not negligence. THE AMENITY EXCEPTION: LEWIS OPERATING CORP. v. SUPERIOR COURT (2011) 200 Cal.App.4th 940 upheld a release in a residential lease for injury at an on-site exercise facility, reading s1953 as protecting the basic need for shelter and treating the gym as a non-essential added benefit. Known here ONLY through its treatment in California Supreme Court briefs and a law-firm summary - the Lewis opinion itself was NOT read. WHITEHEAD v. CITY OF OAKLAND (Cal. May 1, 2025) No. S284303 - RESOLVED, and it SHARPENS the rule against landlords. Unanimous opinion by Justice Evans, with a concurrence by Justice Kruger; official opinion on courts.ca.gov, read at snippet level. Holding: TUNKL GOVERNS RELEASES OF COMMON-LAW NEGLIGENCE ONLY. A release purporting to exempt a party from liability for breaching a STATUTORY DUTY is invalid under Civ. Code s1668's 'violation of law' limb directly, WITHOUT any Tunkl public-interest analysis - the lower courts erred by applying Tunkl to a statutory-duty claim. Reversed and remanded. WHY THIS MATTERS MORE HERE THAN IN MOST CONTEXTS: a residential landlord's duties are overwhelmingly statutory - Civ. Code ss1941 and 1941.1, s1941.3 locks, H&S s13113.7 smoke alarms, H&S s17920.3 and s17920.10 conditions, H&S s17973 balconies, s1954 entry. After Whitehead a lease release cannot reach a claim that ANY of those was breached, irrespective of Tunkl, Henrioulle or the recreational context. LEWIS SURVIVES, BUT NARROWED: Whitehead cites Lewis Operating Corp. (2011) with apparent approval for the proposition that ordinary negligence may be released 'in certain circumstances'. So the recreational-amenity exception still exists - but only for COMMON-LAW negligence. A gym or pool release will not protect a landlord from a claim framed as a statutory or code violation, which is how most such claims can be pleaded. Practical guidance: DO NOT ship an amenity release for CA as a liability shield; at most it reaches ordinary negligence at a genuinely non-essential amenity. Two consecutive state Supreme Court decisions (Henrioulle 1978, Whitehead 2025) now point the same way, and the extend-screen exculpation blocks rest on three independent grounds: s1953(a)(5), Henrioulle, and Whitehead's s1668 statutory-duty rule.",
  },
  {
    id: "edu-no-jury-waiver-ca",
    title: "Jury trial waivers in a lease are unenforceable",
    group: "Compliance & Prohibited Terms",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "In California a contractual waiver of the right to a jury trial made before any dispute arises is unenforceable unless a statute expressly authorizes it, and no statute authorizes one in a residential lease. A jury waiver clause in a California lease therefore has no effect. Separately, a residential lease provision waiving a tenant's procedural rights in litigation is void by statute.",
    notes: "CA: CASE LAW plus statute. GRAFTON PARTNERS L.P. v. SUPERIOR COURT (2005) 36 Cal.4th 944: predispute jury trial waivers are unenforceable in California absent express statutory authorization, because CCP s631 lists the only permissible methods of waiver and none is predispute; the Court expressly overruled Trizec Properties (1991). Opinion text viewed via vLex; holding confirmed across multiple sources. A residential lease jury waiver therefore fails on TWO INDEPENDENT GROUNDS: Grafton, of general application, and Civ. Code s1953(a)(4), which voids waiver of 'procedural rights in litigation'. Either suffices. SCREEN RESULT: the extend-screen pattern search for 'jury|venue|arbitrat' across the 52 base rows found no jury waiver in the base library, so this row changes no current clause - it exists so a future clause is caught. VENUE - DELIBERATELY NOT RESOLVED: EPICENTRX, INC. v. SUPERIOR COURT (Cal. July 21, 2025, S282521) held that a forum-selection clause may be enforced against a California plaintiff even where the chosen forum offers no jury, effectively overruling Handoush v. Lease Finance Group (2019). Known here only through law-firm summaries, and it arose in a CORPORATE context. Whether it reaches a RESIDENTIAL lease - where s1953(a)(4) applies and unlawful detainer has its own statutory venue - is a separate question not researched. Do not draft a CA lease forum-selection clause on the strength of EpicentRx. VENUE RESOLVED ON THE TEXT 2026-09-19: CCP s392(a)(1) makes the superior court in the COUNTY WHERE THE PROPERTY IS SITUATED the proper court for any action to recover real property, and s392(b) fixes the unlawful detainer location to the court nearest the property. A residential lease forum-selection clause moving an eviction elsewhere would conflict with s392 and is void as a waiver of 'procedural rights in litigation' under Civ. Code s1953(a)(4). EpicentRx (Cal. 2025) concerned a corporate forum clause and the jury right; it does not displace s1953(a)(4)'s statutory bar for residential tenancies. Textual conclusion; EpicentRx itself was not read. | CA 2026-09-24 follow-up: EpicentRx, Inc. v. Superior Court (2025) 18 Cal.5th 58 (S282521) READ IN FULL; disapproves Handoush v. Lease Finance Group (2019) 41 Cal.App.5th 729. Its holding is confined to the constitutional jury right, which no statute backs with a voiding rule (art. I s16 and CCP s631 'simply state that such waivers will not be enforced'). The Court expressly preserved the line of statutes that void private waivers of rights (citing Corp. Code s31512, Civ. Code s1751, Lab. Code s219(a)); footnote 7: 'We need not and do not consider the merits of Wimsatt, America Online, Verdugo, or similar cases involving potentially unwaivable substantive rights.' Civ. Code s1953(a) is that form, so EpicentRx does not displace s1953(a)(4) for residential leases. STATED LIMIT: EpicentRx's first distinction was substantive vs procedural and s1953(a)(4) is about procedural rights, and no published case applies s1953(a)(4) to a forum-selection clause - a textual/structural conclusion, not a holding. Footnote 4 preserves overreaching/unequal-bargaining-power grounds; EpicentRx involved sophisticated parties, the opposite of an adhesion lease.",
  },
  // Default & Termination
  {
    id: "edu-waiver-by-acceptance-ca",
    title: "Accepting rent can waive a breach or renew the tenancy",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "waiver-by-acceptance",
    bodyText:
      "In California, a landlord who accepts rent with full knowledge of a tenant's breach waives the right to declare a forfeiture for that breach and for any earlier breach, and is estopped from relying on it. A landlord may avoid that waiver by giving the tenant notice at the time rent is accepted that acceptance is not consent to the breach or a waiver of the right to forfeit. A separate and harder rule applies after a notice terminating the tenancy has expired: accepting rent then creates a presumption that the tenancy was renewed, and a court of appeal has held that a non-waiver clause did not overcome that presumption where the tenant was not yet in breach when the rent was accepted. A non-waiver clause is more likely to hold where the landlord accepts rent after an actual breach, such as unpaid rent following a three-day notice. As a practical matter, rent tendered after a three-day or termination notice expires should be returned rather than accepted if the landlord intends to proceed.",
    notes: "CA: CASE LAW plus Civ. Code s1945. RESOLVES the late-rent acceptance question, and it splits into TWO RULES that must not be merged. RULE 1 - WAIVER OF FORFEITURE FOR A BREACH. KERN SUNSET OIL CO. v. GOOD ROADS OIL CO. (1931, Cal. Supreme Court): accepting rent with full knowledge of a breach waives forfeiture for that breach and any earlier one. Stated in CACI No. 4324, 'Affirmative Defense - Waiver by Acceptance of Rent' - a Judicial Council jury instruction, which is an authoritative statement of the rule. KARBELNIG v. BROTHWELL (1966) 244 Cal.App.2d 333: waiver was AVOIDED where the lease had a non-waiver clause AND the landlord gave CONTEMPORANEOUS NOTICE at acceptance. A Glenn County Superior Court self-help page confirms that a landlord's post-notice waiver nullifies the forfeiture election. RULE 2 - RENEWAL AFTER A TERMINATION NOTICE EXPIRES. Civ. Code s1945 presumes renewal where the lessor accepts rent after expiration. BACA v. KUANG (Cal. Ct. App., c. 2025): a landlord who accepted rent after a 30-day termination notice expired was held to have renewed month-to-month, and the lease's HOLDOVER AND NON-WAIVER PROVISIONS DID NOT REBUT the presumption; the landlord's subjective belief was immaterial. Known ONLY through a law-firm alert (Ballard Spahr) - opinion NOT read - and it was a COMMERCIAL lease. PRODUCT CONSEQUENCE - this bears directly on the reservation-of-rights feature on the legal-tracker roadmap. In CA a contemporaneous reservation notice at acceptance is the Karbelnig route and is worth building, but Baca suggests it is NOT enough after a termination notice has expired: the safe course there is to REFUSE or RETURN the payment. So the CA version of that feature needs a second branch - 'return, don't reserve' once a notice has run. CCP s1161.1 permits a COMMERCIAL landlord to accept partial rent after notice and still proceed; secondary sources describe no residential equivalent. s1161.1 NOT READ. | CA 2026-09-24 follow-up: Baca v. Kuang (2025) 107 Cal.App.5th 1292 (1st Dist., Div. 5, No. A171071; published except Discussion parts B and E) READ IN FULL. Holds that a landlord who deposits and retains rent after a termination notice expires triggers the Civ. Code s1945 renewal presumption regardless of subjective intent; the presumption is rebuttable; filing the unlawful detainer did not rebut it; each later unqualified acceptance creates a fresh presumption. Reasoning rests on s1945's text ('a lessee of real property') and on residential authority (Kaufman v. Goldman (2011) 195 Cal.App.4th 734, where returning checks uncashed and refunding one mistakenly deposited meant no acceptance), so it reaches residential tenancies and is the direct authority for 'return, don't reserve'. CCP s1161.1's partial-rent safe harbor is commercial-only, so residential landlords have less protection. BODYTEXT CORRECTED: the prior sentence said non-waiver and holdover clauses 'did not overcome' the presumption - too broad. The clause in Baca failed because it addressed waiver of a PRECEDING BREACH and there was none (the lease's own 10-day cure period meant holding over was not yet a breach); Woodman Partners v. Sofa U Love (2001) 94 Cal.App.4th 766 shows a no-waiver clause can work after an actual breach. See also Superior Strut & Hanger Co. v. Port of Oakland (1977) 72 Cal.App.3d 987; Aviel v. Ng (2008) 161 Cal.App.4th 809.",
  },
  {
    id: "edu-self-help-eviction-ban-ca",
    title: "No lockouts, utility shutoffs or removal of belongings",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "self-help-eviction",
    bodyText:
      "A California landlord may not, with intent to end a residential tenancy, willfully cause any utility service to the tenant to be interrupted or terminated - including water, heat, light, electricity, gas, telephone, elevator or refrigeration - whether or not the landlord controls the utility. Nor may the landlord change the locks or use a bootlock or similar device to keep the tenant out, remove outside doors or windows, or remove the tenant's belongings or furnishings without the tenant's prior written consent, except under the statutory procedure for property left after a tenancy ends. The only lawful way to remove a tenant is through a court eviction carried out by the appropriate authorities. A landlord who violates this is liable for the tenant's actual damages plus up to $100 for each day or part of a day the violation continues, with a minimum of $250 for each separate violation, and the prevailing party recovers attorney's fees. A repeat violation on a later occasion counts as a new violation with its own award.",
    notes: "CA: Civ. Code s789.3, primary text supplied by Taylor 2026-09-19 (amended Stats. 1979 ch. 333). CLOSES THE GAP IDENTIFIED IN s5.25: California's self-help eviction ban had no row. It sits in DIVISION 2 (Property), Part 2, Title 2, Chapter 2 'Termination of Estates' - an entirely different division from the Title 5 landlord-tenant chapters, which is why the Chapters 1-2 sweep missed it. The seventh cross-chapter confirmation in CA and the most consequential. THE INTENT ELEMENT is the key to applying it correctly: every limb requires the act be done 'with intent to terminate the occupancy' and 'willfully'. A utility outage the landlord did not cause for that purpose, or a lock change made for a lawful reason, is outside it. That is why s1941.6(d) needs to EXPRESSLY disapply s789.3 for a court-ordered DV lock change - the exclusion there would otherwise be a lockout of the restrained person. Cross-noted at edu-abuse-violence-protections-ca. s789.3(a) reaches utilities 'whether or not the utility service is under the control of the landlord' - so INDIRECTLY causing a shutoff, e.g. by not paying a landlord-account utility with intent to force the tenant out, is within it. s789.3(b)(3) property removal is lawful ONLY through the Civ. Code s1980 et seq. procedure - which ties this row directly to edu-abandoned-property-ca. Removing belongings outside that procedure is both a s789.3 violation and a loss of the s1989 liability shield. REMEDY SHAPE, s789.3(c): actual damages PLUS a DAILY penalty up to $100 with a $250 MINIMUM PER SEPARATE CAUSE OF ACTION, and non-contemporaneous repeat violations are separate causes of action with separate awards. So the exposure ACCRUES DAILY - a three-week lockout is up to $2,100 before actual damages. Compare the candidate-table figures: CO greater of 3x rent or $5,000; KS 1.5 months' rent; MN treble or $500. CA's per-violation floor is lower but its daily accrual is uncapped. s789.3(d): prevailing-party fees, injunctive relief during the action, non-exclusive. s789.3(b) final paragraph excludes the s1940(b) transient occupancies and expressly preserves lawful eviction by appropriate legal authorities. PRODUCT CONSEQUENCE: the legal tracker and any automated late-rent workflow must NEVER suggest a lock change, utility interruption, or removal of belongings as a nonpayment remedy in CA. It also bears on s1940.2(a)(3) harassment and the s1942.5 retaliation window, which can stack on the same conduct.",
  },
  // Landlord Responsibilities
  {
    id: "edu-military-tenant-protections-ca",
    title: "Military tenants: no chain-of-command contact, no waivers",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "military-tenant-protections",
    bodyText:
      "In collecting any debt or payment from a member of the active California militia or an active or reserve member of the Armed Forces, including unpaid rent, a California landlord may not contact the member's military unit or chain of command without the member's written consent, and that consent counts only if it is given after the obligation has become due and payable. A lease clause consenting in advance to contact with a commanding officer is therefore ineffective, and any waiver of these protections is void. A landlord may not condition a military or veteran discount on the tenant waiving any legal right. A service member's application for or receipt of a stay or postponement of an obligation under California's military protections may not by itself be treated as showing that the member cannot pay. A landlord may not electronically access a service member's Common Access Card, place it in a card reader, or ask for its PIN. Violations carry actual damages, attorney's fees and costs, and are a misdemeanor.",
    notes: "CA: Mil. & Vet. Code s401, primary text supplied by Taylor 2026-09-19 (amended SB 1311, Stats. 2022 ch. 620, eff. 2023-01-01), read with the s400 definitions. NOT a lease-termination right - s401 is a set of debt-collection, credit and anti-waiver protections - but it bears on landlords directly. s401(c) IS THE LANDLORD-FACING RULE and the one most likely to be breached: contacting a military tenant's UNIT OR CHAIN OF COMMAND to collect rent is a common landlord tactic, and it is barred unless the member gives written consent AFTER the rent is due and payable. That timing requirement means NO LEASE CLAUSE can supply the consent - consent in a lease is necessarily given before any obligation is due - and s401(e)(2) voids any waiver of a right this code gives service members. Screen found no such clause in the current library; this row exists so one is never added. Note the protected class under (c) is broader than the s400(d) 'service member' definition: it reaches any member of the active militia or an active OR RESERVE component, regardless of active orders. s401(a)(1) applies to 'any lender OR OTHER PERSON', which reaches a landlord: use of a Chapter 7.5 stay may not by itself ground a finding of inability to pay. Relevant to screening and to s1954.07 rent reporting. s401(e)(1): a military or veteran discount may not be conditioned on waiving any right - relevant if a landlord offers military pricing. s401(d): CAC card access in a transaction voids the transaction; photocopying is not addressed by the text and was not researched. REMEDIES: s401(f) actual damages, fees and costs; s401(g) misdemeanor, up to one year and/or $1,000. s402 SINCE READ - default-judgment declaration, 120-day lookback, mandatory 90-day stay; see edu-military-default-judgment-ca. s403 (stays) also read. CHAPTER 7.5 NOW READ IN FULL (2026-09-19). CA DOES have a state lease-termination right - s409, see military-lease-termination-ca. s409.15 imposes a 30-DAY WRITTEN-RESPONSE duty on any good-faith request for relief, on pain of waiving objection. s405 caps interest at 6% on PRE-service interest-bearing obligations and defines interest to include fees and charges - an ordinary lease does not bear interest, so it will rarely reach rent, but it would reach a pre-service payment plan charging interest. Whether CA's protections as a whole are narrower or broader than the federal SCRA was not assessed - the federal statute was not read. Federal SCRA 50 U.S.C. s3955 governs termination regardless - see early-termination-ca.",
  },
  // Default & Termination
  {
    id: "edu-military-default-judgment-ca",
    title: "Military tenants in eviction: declaration, stays and dependents",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "military-default-judgment",
    bodyText:
      "Before a California court will enter a default judgment - which is how most eviction cases end - the landlord must file a declaration under penalty of perjury stating facts showing the tenant is not in military service, or else declaring that the tenant is in service or that the landlord cannot determine whether they are. A tenant counts as in military service if they are currently serving or served within the preceding 120 days. Without a declaration showing the tenant is not in service, judgment cannot be entered without a court order, and if the tenant is in service the court must first appoint an attorney to represent them; the court may also require the landlord to post a bond. Where a defense may exist that cannot be presented without the tenant, the court must stay the case for at least 90 days. A judgment entered against a service member during service or within 30 days after may be reopened on application within 90 days after service ends. Knowingly making a false declaration is a misdemeanor, and carries liability for damages and attorney's fees. Separately, at any stage of any case involving a service member during service or within 120 days after, the court must stay the case on the service member's application unless their military service does not materially affect their ability to take part, and on the same test may stay execution of any judgment - including an eviction order - and vacate or stay any attachment or garnishment. A stay can run for the period of service plus three months, on terms the court sets, which may include payment in installments. No fine or penalty accrues during a stay of an action to enforce a contract, and a court may relieve a service member from a penalty - such as a late fee - incurred while in service if service materially impaired their ability to pay. Where the service member is one of several co-tenants, the landlord may, with the court's leave, proceed against the others. Where the unit is occupied primarily as a home by a service member's spouse, children or other dependents, no eviction may be carried out during the period of military service or until 120 days after release except with the court's permission, and the court must stay the case or order partial payments on application unless the tenant's ability to pay is unaffected. Knowingly taking part in such an eviction is a misdemeanor.",
    notes: "CA: Mil. & Vet. Code s402, primary text supplied by Taylor 2026-09-19 (amended SB 1097, Stats. 2024 ch. 129, eff. 2025-01-01). The state analog of the federal SCRA default-judgment protections, applying in ANY action - and therefore to every unlawful detainer. A LEGAL-TRACKER STEP, not lease text: the eviction workflow must prompt for this declaration before any default judgment is requested. s402(f) IS THE DETAIL TO BUILD AROUND: 'in the military service' includes anyone who SERVED WITHIN THE PRECEDING 120 DAYS, not only those currently serving. A status check run only against current service is therefore insufficient in CA. 'Military service' itself is the s400(c) definition - militia on full-time active state or federal service, or otherwise full-time active duty exceeding seven days in any 14-day period. s402(a): three possible declarations - NOT in service; IN service; or UNABLE TO DETERMINE. Only the first permits judgment without a court order. If the tenant is in service, no order until the court appoints counsel; the court may require an INDEMNITY BOND as a condition of judgment. s402(c): a MANDATORY stay of at least 90 days where a defense may exist that cannot be presented without the defendant, or counsel cannot reach them. s402(e): reopening within 90 days after service ends, on showing prejudice and a meritorious defense; a bona fide purchaser's title under the judgment is protected. s402(b): a KNOWINGLY FALSE declaration is a misdemeanor (up to one year and/or $1,000) PLUS actual damages, fees and costs - so a landlord who signs a 'not in service' declaration without checking is exposed. The federal SCRA default-judgment provision (50 U.S.C. s3931) and its DoD status-verification practice were NOT read; whether CA's 120-day lookback is broader than the federal rule is not established here. Both apply. Chapter 7.5 beyond s402 remains unread, including any state lease-termination right. s403 READ 2026-09-19 (amended SB 1097, eff. 2025-01-01) - THE STAY PROVISIONS, now folded into this row so the legal tracker has a single military step. s403(a): stay of the ACTION, discretionary on the court's own motion but MANDATORY on application unless the court finds no material effect - the burden effectively runs against proceeding. s403(c)(1): stay of EXECUTION of any judgment or order - which in an unlawful detainer is the WRIT OF POSSESSION, so a landlord holding a judgment may still be unable to recover the unit. Both reach the same 120-DAY post-service window as s402(f). s403(d): up to the period of service PLUS THREE MONTHS, with installment terms possible. s403(b) BEARS ON LATE FEES: no fine or penalty accrues during a stay of an action to enforce a contract, and a court may RELIEVE a service member from a penalty incurred while in service where service materially impaired the ability to pay. A rent late fee is such a penalty. Cross-noted at late-fee-safe-harbor-ca. s403(d) last sentence: where the service member is a CODEFENDANT, the landlord may proceed against the others BY LEAVE OF COURT - relevant to multi-tenant units. s403(e): a further stay may be sought, and if refused the court must appoint counsel. s403(f): applying for a stay is not an appearance and waives no defence, including lack of personal jurisdiction. Still no state lease-TERMINATION right in ss400-403; any such right would be in s404 et seq., unread. s406 READ 2026-09-19 - THE STRONGEST LIMB, and a separate rule from the s403 stays: where premises are occupied PRIMARILY FOR DWELLING by a service member's SPOUSE, CHILDREN OR OTHER DEPENDENTS, NO EVICTION OR DISTRESS may be made during the period of service or until 120 days after release EXCEPT ON LEAVE OF COURT. So the default is BARRED, not merely stayable. On application the court shall stay, or may order partial payments, unless ability to pay is unaffected. Knowingly taking part in an eviction in breach is a MISDEMEANOR (s406(d)) plus damages and fees. s406 carries NO RENT CEILING on its face; the federal analog was not read. Where a stay is granted, the OWNER may seek reciprocal relief on its own mortgage and similar obligations (s406(b)). Also: s409.3 lets a service member petition within six months after service to defer PRE-SERVICE obligations (which can include rent under a lease signed before service), hearing within 25 days, no filing fee, no penalties or interest during deferment; s409.8 makes an officer's certificate prima facie evidence of service status - the practical evidence for the s402 declaration; s409.7 disregards transfers made to exploit the chapter; s409.14 no filing fees for service members. Chapter 7.5 now READ IN FULL.",
  },
  // Landlord Responsibilities
  {
    id: "edu-megans-law-housing-use-ca",
    title: "Megan's Law website data may not be used in housing decisions",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["PROHIBITED"],
    verificationStatus: "VERIFIED",
    topicKey: "megans-law-housing-use",
    bodyText:
      "California prohibits using information from the Megan's Law sex-offender website for purposes relating to housing or accommodations. The only authorized use of that information is to protect a person at risk of becoming a victim of a sex offense committed by the registrant. A landlord who uses it otherwise - for example, to screen out an applicant - is liable for actual damages, up to three times actual damages with a minimum of $250, attorney's fees, and exemplary damages or a civil penalty of up to $25,000, and prosecutors or an aggrieved person may sue to stop a pattern or practice of misuse. Every California lease must still tell tenants that the website exists; the landlord may point tenants to it, but may not use it to decide who to rent to.",
    notes: "CA: Pen. Code s290.46(j), primary text read 2026-09-19 via FindLaw ('current as of January 01, 2026'; section operative 2022-01-01). ANSWERS candidate 572.6 - and runs the OPPOSITE WAY from the Ohio precedent: Ohio creates a landlord termination route for a sex offender residing near a school (s5321.051); California PROHIBITS using registry data in housing at all. s290.46(j)(1): use authorized ONLY to protect a 'person at risk'. s290.46(j)(2)(G): use 'for purposes relating to... HOUSING OR ACCOMMODATIONS' is prohibited except as (1) or another law authorizes. s290.46(j)(4)(A): actual damages; up to 3x; NOT LESS THAN $250; attorney's fees; exemplary damages OR a civil penalty up to $25,000. (j)(4)(B): pattern-or-practice injunctions by the AG, a DA, a city attorney or ANY AGGRIEVED PERSON. s290.46(h): using the information to commit a misdemeanor adds a $10,000-$50,000 fine. THE TENSION WORTH SURFACING: Civ. Code s2079.10a REQUIRES every CA lease to tell tenants about the website (sex-offender-registry-notice-ca), while s290.46(j) forbids the landlord from using it to choose tenants. Both hold. PRODUCT CONSEQUENCE: the screening workflow must NOT query the Megan's Law website or ingest its data as an eligibility input. SCOPE LIMIT: s290.46(j) restricts information 'disclosed pursuant to THIS SECTION' - i.e. the website. A sex-offense CONVICTION in a lawful consumer report is a different source, governed instead by 2 CCR ss12264-12271 (directly-related convictions only; no blanket bans). Whether a screening vendor's registry-derived field counts as 'information disclosed pursuant to this section' is NOT resolved - treat such fields as prohibited until checked. The 'person at risk' exception (defined in Pen. Code s290.45) was not read. 'PERSON AT RISK' - UNDEFINED IN THE CURRENT TEXT, read 2026-09-19: older commentary cites a definition at Pen. Code s290.45(a)(8) ('a person who is or may be exposed to a risk of becoming a victim of a sex offense committed by the offender'). The CURRENT s290.45 - repealed and re-added by SB 384, operative 2021-01-01 - contains NO such definition and no subdivision (a)(8). So the landlord's only exception in s290.46(j)(1) turns on a term whose statutory definition appears to have been dropped in the re-enactment. Another cross-reference-rot instance. Practical effect: do not build any 'person at risk' exception into the product; the prohibition is the operative rule. s290.45(e)(2) adds a $500-$1,000 fine for using s290.45 disclosures to commit a misdemeanor.",
  },
  // Security Deposit
  {
    id: "edu-deposit-escheat-ca",
    title: "Unreturned deposits escheat to the state after three years",
    group: "Security Deposit",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "An amount a landlord owes a former tenant - most often an unreturned security deposit refund - that the tenant has not claimed is unclaimed property under California law. If it remains unclaimed for more than three years after it became payable, it escheats to the state, and the landlord, as the holder, must report and remit it to the State Controller. Holders file an annual report before November 1 covering property escheated as of the preceding June 30.",
    notes: "CA: CCP s1520(a) and s1530(d), read 2026-09-19 from Justia's 2025 code and FindLaw via search results. ANSWERS candidate 427.2: a CA landlord holding an unclaimed deposit refund is a HOLDER under the Unclaimed Property Law. s1520(a): intangible personal property 'held or owing in the ordinary course of the holder's business' and unclaimed for MORE THAN THREE YEARS after it became payable escheats, 'deducting any lawful charges'. s1530(d): report before NOVEMBER 1 each year as of June 30; items under $25 may be aggregated. PARTIAL, stated plainly: the holder's PRE-ESCHEAT OWNER NOTICE (which s1520's later subdivisions prescribe for deposits and accounts, with bold or larger-type content requirements), the PENALTY and INTEREST provisions, and record-retention rules were NOT read in full. Candidate 427.3 (dormancy charge as a drafting hook): s1520 permits deducting 'lawful charges', but whether a lease can create one for an unreturned deposit was NOT established - the charge provisions were not read. Note the interaction with s1950.5(h): the 21-day return duty means a refund that goes unclaimed is usually a check that was never cashed, and the three-year clock runs from when it became payable. ARTICLES 2 AND 3 READ IN FULL 2026-09-19 - the partial flags are resolved. PRE-ESCHEAT NOTICE, s1520(b): for property worth $50 OR MORE where the holder has an address, notice by mail (or electronically with consent) 6 TO 12 MONTHS before it becomes reportable, headed verbatim 'THE STATE OF CALIFORNIA REQUIRES US TO NOTIFY YOU THAT YOUR UNCLAIMED PROPERTY MAY BE TRANSFERRED TO THE STATE IF YOU DO NOT CONTACT US' (or substantially similar), with four specified statements in BOLD or at least two points larger, plus the Controller's address-confirmation form; owner contact restarts the escheat period; a notice charge of no more than $2. DORMANCY CHARGES - candidate 427.3 RESOLVED, and it is the OPPOSITE of North Dakota: s1520(d) defines 'lawful charges' as those authorized by statute or a valid contract, BUT s1522 bars deducting ANY charge 'imposed because of the inactive or unclaimed status' unless THIS CHAPTER specifically permits it - and even then not if the holder would not have deducted it had the owner claimed in time. The only chapter-permitted charge is the $2 notice fee. So a lease clause creating a dormancy charge on an unclaimed deposit is ineffective in California. REPORT AND REMIT: s1530(d) report before NOVEMBER 1 as of June 30, verified by the holder (s1530(e)); names and addresses for items of $25 or more, smaller items aggregated. s1532(a): remit no sooner than SEVEN MONTHS and no later than seven months and 15 days after the report deadline; cash of $2,000 or more by EFT, with a 2% civil penalty for paying otherwise (s1532(h)). s1532(b): if the owner claims before remittance, pay the owner and file a report instead. STILL UNREAD: the s1577 interest provision that s1532(c) references, and the late-reporting penalty sections. GROUP NORMALISED 2026-09-19: 'Security Deposits' -> 'Security Deposit' (session drift; 12 canonical groups are used by all nine states).",
  },
  // Default & Termination
  {
    id: "edu-writ-execution-ca",
    title: "After judgment: the writ of possession and occupant claims",
    group: "Default & Termination",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "writ-execution",
    bodyText:
      "In California a judgment for possession is enforced by a writ of possession executed by the sheriff or marshal. The officer serves the writ on an occupant, or posts it and serves the tenant, and the occupants then have five days to leave; that period cannot be extended. If the officer does not execute the writ within three court days, a registered process server may. An occupant not named in the judgment who was living there when the case was filed may file a claim of right to possession, which stops the eviction pending a hearing, unless a prejudgment claim form was served on all occupants with the summons. Personal property left behind after the landlord takes possession must be stored and may be reclaimed within 15 days on payment of reasonable storage costs, after which it is sold or disposed of under the abandoned-property procedure. A tenant's bankruptcy filing does not delay execution of the possession writ, and a forfeiture judgment does not end the tenant's liability for damages.",
    notes: "CA: CCP ss715.010-715.050 and 1174(d)-(m), 1174.3, 1174.25, 1174.5, primary text supplied by Taylor 2026-09-19. ANSWERS candidates 367.3 and 367.5. A LEGAL-TRACKER row. TIMING: s715.020(c) - FIVE DAYS from service on an occupant (or on the judgment debtor where posted), and CCP s684.120 time extensions expressly DO NOT apply. s715.040: if the sheriff or marshal does not execute within THREE court days, a registered process server may. No daylight-only or SSI/SSDI extension of the Colorado kind was found. s715.050: execution proceeds WITHOUT DELAY notwithstanding notice of the tenant's BANKRUPTCY filing, except as to money judgments and mobilehome writs. OCCUPANT CLAIMS: s715.020(d) bars removing an unnamed person who claims possession predating the action, UNLESS a PREJUDGMENT claim of right to possession was served on all occupants under CCP s415.46 (NOT READ) - so serving the prejudgment form with the summons is what closes this gap, and the tracker should prompt for it. s1174.3: a claim at the writ stage stops the eviction on the spot; the claimant deposits 15 days' rent (or proceeds without it on a fee waiver) and a hearing follows in 5-15 days. s1174.25: a prejudgment claimant has 10 days to file and is added as a defendant. PROPERTY: s715.010(b)(3) and s715.030 route post-writ property through s1174(e)-(m) - 15 DAYS to reclaim on payment of storage costs, lost property to police under s2080 et seq., non-tenant owners noticed under Civ. Code s1983, disposal under s1988, with liability shields paralleling s1989. s1174(h) also references Civ. Code s1965 (NOT READ). SERVICE-MEMBER tenants: storage liens need a court order first (Mil. & Vet. Code s409.1(b)). s1174.5: a forfeiture judgment does NOT relieve s1951.2 damages liability.",
  },
  // Tenant Responsibilities
  {
    id: "edu-sublet-consent-choice-ca",
    title: "Choosing a subletting consent standard",
    group: "Tenant Responsibilities",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "sublet-consent-choice",
    bodyText:
      "A California landlord can require its consent to any sublease or assignment, and must choose how that consent works. Under the reasonable-consent standard, the landlord may refuse only for a reasonable reason - a prospective subtenant's poor credit or rental history, for example - and must be prepared to justify a refusal. In exchange, if the tenant later breaks the lease and moves out, the landlord may keep the lease in force and collect rent as it comes due for the rest of the term. Under the sole-discretion standard, the landlord may refuse for any lawful reason and keeps full control over who lives in the property, but gives up that remedy: if the tenant breaks the lease and moves out, the landlord must end the lease and sue for its losses, and the tenant can reduce what they owe by showing the landlord could have re-rented the unit. Either way, a sublease cannot charge more than the lawful rent, a refusal can never be based on a protected characteristic, and an unauthorized sublease is grounds for eviction.",
    notes: "CA: the landlord-facing explanation for CHOICE GROUP 'ca-sublet-consent' - show at the point of selection. Sources: Civ. Code ss1951.4(b), 1951.2(a)(2)-(3) and (c), 1947.12(c), 1946.2(b)(1)(G); fair-housing limits under Gov. Code s12955. Written plainly for a landlord choosing between no-sublet-assign-ca (default) and no-sublet-assign-discretion-ca. GROUP NORMALISED 2026-09-19: 'Property Use' -> 'Tenant Responsibilities' (session drift; 12 canonical groups are used by all nine states).",
  },
  // Security Deposit
  {
    id: "edu-no-deposit-interest-ca",
    title: "No state duty to pay interest on deposits",
    group: "Security Deposit",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California imposes no statewide requirement to pay interest on a security deposit or to hold it in a separate interest-bearing account. Some California cities do require deposit interest by ordinance, so a landlord should check local rules for the city where the property is located.",
    notes: "CA: CONFIRMED ABSENT. Civ. Code s1950.5 was read section-open IN FULL and contains no interest requirement anywhere - not in (b) permitted purposes, (c) the cap, (e) deductions, or (h) return mechanics. Proof-of-absence from the governing statute read end to end, not an inference from silence. Municipal layer flagged and NOT resolved - several CA cities impose deposit interest by ordinance; see edu-municipal-layer-ca. Row added 2026-09-19 for consistency with the confirmed-absence rows other states ship (edu-no-deposit-installments-ks etc.); the finding itself dates from the s1950.5 read earlier in the pass. GROUP NORMALISED 2026-09-19: 'Security Deposits' -> 'Security Deposit' (session drift; 12 canonical groups are used by all nine states).",
  },
  // Landlord Responsibilities
  {
    id: "edu-no-move-in-inventory-ca",
    title: "No joint move-in inventory requirement",
    group: "Landlord Responsibilities",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    ...
    bodyText:
      "California does not require a joint, signed move-in condition inventory. It substitutes two different mechanisms: the tenant may request an initial inspection during the final two weeks of the tenancy, and for tenancies beginning on or after July 1, 2025 the landlord must photograph the unit at the start of the tenancy.",
    notes: "CA: CONFIRMED ABSENT as a joint signed instrument, from Civ. Code s1950.5 read in full. What CA has instead is s1950.5(f) (tenant-requested INITIAL INSPECTION in the final two weeks - a move-OUT device) and s1950.5(g)(1) (landlord PHOTOGRAPHS at the start of tenancies beginning on or after 2025-07-01). A canvass looking for the usual joint-inventory shape would record 'absent' and miss that CA covers the same ground unilaterally. See security-deposit-return-ca. GROUP NORMALISED 2026-09-19: 'Property Condition' -> 'Landlord Responsibilities' (session drift; 12 canonical groups are used by all nine states).",
  },
  // Security Deposit
  {
    id: "edu-no-deposit-installments-ca",
    title: "No right to pay the deposit in installments",
    group: "Security Deposit",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "deposit-installments",
    bodyText:
      "California gives tenants no statutory right to pay a security deposit in installments. The statutory cap reduces the need for one: since July 1, 2024 security may not exceed one month's rent for most landlords.",
    notes: "CA: CONFIRMED ABSENT from Civ. Code s1950.5 read in full - no installment or payment-plan right appears anywhere. Note s1950.5(c)(1) caps security at ONE MONTH'S RENT from 2024-07-01 (two months for the small-owner exception at (c)(5), disapplied for service members). Municipal ordinances not screened. See security-deposit-cap-ca. GROUP NORMALISED 2026-09-19: 'Security Deposits' -> 'Security Deposit' (session drift; 12 canonical groups are used by all nine states).",
  },
  // Disclosures
  {
    id: "edu-no-radon-disclosure-ca",
    title: "No radon disclosure requirement",
    group: "Disclosures",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    ...
    topicKey: "radon-disclosure",
    bodyText:
      "California has no statute requiring a residential landlord to test for radon or to disclose radon to tenants. The state's radon provision addresses construction standards for new buildings rather than landlord duties, and California's Proposition 65 warning requirement does not reach radon, because radon is not on the state's list of chemicals known to cause cancer or reproductive toxicity. A known radon problem can still matter: conditions severe enough to affect habitability run through the ordinary habitability rules, and a landlord who conceals a known hazard can face liability on other grounds.",
    notes: "CA: CONFIRMED ABSENT FROM THE GOVERNING TITLE, with the scope stated. Civ. Code Title 5 Chapters 1-2 (ss1925-1954.071) were swept end to end 2026-09-19 and contain no radon provision. This is NOT a whole-code proof: a radon duty outside Title 5 - in the Health and Safety Code, say - was not searched for. Recorded at that strength deliberately, since CA's disclosure duties are scattered across at least four codes. | CA 2026-09-24 follow-up: NOT CLOSED - set to NEEDS_REVIEW. Searched: CDPH Radon Program 'Radon and Real Estate' page (points to natural-hazard disclosure sections and the Residential Environmental Hazards booklet; no rental disclosure duty), targeted searches for a CA radon landlord disclosure/testing statute (secondary sources only, all saying none), practitioner lists of CA required disclosures (radon absent from all). Consistent but not primary. NEW LEAD: Proposition 65 (H&S s25249.6) requires a business to warn before knowingly exposing anyone to a listed chemical, and OEHHA has residential-rental safe-harbor warnings (27 CCR ss25607.34-25607.35). Whether radon is on the Prop 65 list is UNVERIFIED; if it is, a landlord above the employee threshold who knows of a radon exposure may owe a warning. bodyText narrowed to the interim text pending that check. To close, needed (ranges): the H&S chapter TOC for CDPH's indoor-radon provisions (Div. 103/104); the current OEHHA Prop 65 list entry for radon (list dated 2023-12-29 or later); 27 CCR Art. 6, ss25600-25607.35; H&S ss25249.6 and 25249.11. | CA 2026-09-24 second follow-up: CLOSED, back to VERIFIED. Three independent routes, all negative: (1) Civ. Code Title 5 Chs. 1-2 read end to end - no radon provision; (2) H&S s105430 (Div. 103, Pt. 5, Ch. 7, Indoor Environmental Quality) is the radon provision and governs construction standards for NEW BUILDINGS and a radon assessment/mitigation plan conditioning building permits - no landlord, tenancy, disclosure or testing duty; s105430(e) makes (a)-(d) operative only if federal funds are available (same contingent-commencement shape as H&S s26147 for mold); (3) Prop 65 closed at the list - s25249.6 reaches only chemicals on the s25249.8 list, and the OEHHA list (dated 2023-12-29) has no radon entry; s25249.11(b) would exclude landlords under 10 employees regardless. SCOPE: confirmed absent from those three routes; Div. 103 and 104 were selected by part/article title, not read in full - not a whole-code proof.",
  },
  {
    id: "edu-prop65-rental-warning-ca",
    title: "Proposition 65 Rental Property Warnings",
    group: "Disclosures",
    states: ["CA"],
    ruleTypes: ["REQUIRED"],
    verificationStatus: "VERIFIED",
    topicKey: "prop65-rental-warning",
    bodyText:
      "A California landlord with ten or more employees must give tenants a Proposition 65 warning before knowingly exposing them to a chemical the state lists as causing cancer or reproductive harm. In rental housing these are typically tobacco smoke, engine exhaust, carbon monoxide, lead or asbestos. The warning goes to each known adult occupant when the property is rented and again every year after that. It may be delivered by letter addressed to each known adult occupant, by email to the addresses the landlord otherwise uses to reach them, or in the lease itself - but a warning given in the lease covers only the adults who sign it or are named in it, so other occupants still need a letter or email. If the lease or any other required notice is given in another language, the warning must be given in that language too. The regulation prescribes the wording, which names the exposure source and the chemical, tells the tenant to talk to the landlord about how and when exposure could occur, and directs them to www.P65Warnings.ca.gov/apartments. Properties with an enclosed parking facility or a designated smoking area need separate warnings for those areas. Violations carry civil penalties of up to $2,500 per day, and private parties may sue after giving 60 days' notice.",
    notes: "CA: H&S ss25249.6, 25249.11(b) and 27 CCR ss25607.34-25607.35, read 2026-09-24 (Claude Desktop follow-up, primary text supplied by Taylor). Surfaced while closing the radon row - radon is not on the Prop 65 list, but the residential-rental warning regime it sits in IS a real CA landlord duty the library had no row for in any state. Trigger is a knowing exposure to a LISTED chemical (s25249.8 list), by a landlord employing 10 OR MORE (s25249.11(b)); s25249.10(c) exempts exposures posing no significant risk, WITH THE BURDEN ON THE LANDLORD, and s25249.10(b) gives a 12-month grace after a chemical is listed. THE ANNUAL REPETITION IN s25607.34(b) IS THE REQUIREMENT LANDLORDS MISS - the duty is not discharged at move-in. Lease delivery under (b)(3) is the weakest method: it binds only signers and named adults, and in a renewal year covers only that year. s25607.34(c) language duty attaches to any language used for the lease or other required notices - cross-refer Civ. Code s1632. s25607.34(d) requires separate enclosed-parking (ss25607.20-.21) and designated-smoking-area (ss25607.28-.29) warnings. Content per s25607.35 includes the s25603(a)(1) symbol - s25603 NOT READ, so the symbol specification is unverified. Article 6 is SAFE HARBOUR ONLY: s25600(a) says nothing in it determines whether a warning is required, and s25600(f) permits other compliant wording. Enforcement: s25249.7(b)(1) up to $2,500 per day per violation; (c) AG, DA or city attorney; (d) private enforcement 60 days after notice with a certificate of merit. s25249.7(k)(1)(C)-(D): for environmental tobacco smoke on premises where smoking is permitted, and engine exhaust inside a parking facility, a landlord can cut off a private action once by correcting within 14 days and paying a $500 penalty (CPI-adjusted every five years) - a genuine safe harbour worth surfacing in the tracker. Regulations filed 2019-03-12, operative 2019-07-01.",
  },
  // Rent & Payment
  {
    id: "edu-no-postdated-check-rule-ca",
    title: "No special rule for postdated checks",
    group: "Rent & Payment",
    states: ["CA"],
    ruleTypes: ["CONSTRAINED"],
    verificationStatus: "VERIFIED",
    topicKey: "postdated-check-rule",
    bodyText:
