...
const LANDLORD_EDUCATION = [
  ...
  // Disclosures
  {
    ...
    topicKey: "radon-disclosure",
    bodyText:
      "California does not require a landlord to disclose radon. Its residential disclosure set is extensive and specific - bed bugs, mold, methamphetamine and fentanyl contamination, flood hazard, the sex-offender registry, former ordnance locations, demolition permits, shared utility meters and pest control - and radon is not among them.",
    notes: "CA: CONFIRMED ABSENT FROM THE GOVERNING TITLE, with the scope stated. Civ. Code Title 5 Chapters 1-2 (ss1925-1954.071) were swept end to end 2026-09-19 and contain no radon provision. This is NOT a whole-code proof: a radon duty outside Title 5 - in the Health and Safety Code, say - was not searched for. Recorded at that strength deliberately, since CA's disclosure duties are scattered across at least four codes.",
  },
  // Rent & Payment
  {
