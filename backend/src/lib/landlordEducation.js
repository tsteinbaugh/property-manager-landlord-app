...
// verification passes (Aug-Sep 2026, now 7 states: CO, WY, KS, NE, MN, ND,
// SD) -- real, verified state law that doesn't belong in tenant-facing lease
// text (see `lease-clause-decision-log-CO.md` §7's three-bucket screening
// test: LEASE_CLAUSE / LANDLORD_EDUCATION / OUT_OF_SCOPE, reused unchanged
// by every state since). Typical reasons an item lands here instead of
// `clauseTemplates.js`: it states a legal ceiling/floor with no upside to
// telling the tenant; it's a standing rule that applies regardless of what
// the lease says (rent-increase frequency, retaliation, a police-call-waiver
// ban); it's an operational duty, not lease-drafting content (a landlord-
// identity-change notice, an escheat filing calendar); or it's a
// **documented absence** -- a state simply has no equivalent to another
// state's protection (no deposit cap, no entry-notice statute, no for-cause
// eviction tenure threshold, etc.), logged here so that finding isn't
// silently lost the way an unrecorded "checked, found nothing" tends to be.
// Per the architecture-review log's Addendum H, a verified absence is
// treated as equally load-bearing as a verified presence throughout this
// project -- do not treat these "no such rule" rows as filler.
//
...
// `lease-clause-decision-log-<STATE>.md` and
// `lease-clause-decision-log-architecture-review.md` -- this file is their
// compiled copy, regenerated wholesale from the CSV (2026-09-13 refresh: 24
// -> 307 entries across the now-7-state pass).
//
...
const LANDLORD_EDUCATION = [
  ...
  },
  {
    ...
    notes: "Added 2026-09-07 (cross-state core-obligations canvass, run during the SD re-audit). C.R.S. 38-12-103(8), added by HB 25-1249 (ch. 401, pp. 2273, 2277, SS 2, 3), effective January 1, 2026 and applying to conduct on or after that date. **GENUINE GAP: no CO row covered this.** CO's re-audit captured five other HB 25-1249 elements - the 125% bad-faith presumption, the walkthrough right, the ten-year carpet rule, pet caps, and the 38-12-103(7) non-waiver - but not the documentation duty. WHY IT MATTERS BEYOND ITS OWN TERMS: 38-12-103(3)(b) and (3.5)(c) put the burden on the LANDLORD to prove both that a retention was not wrongful and the amount of actual damages, and 38-12-103(2.5) deems a withholding wrongful where the written statement omits exact reasons. A landlord who has not retained photographs, invoices and estimates therefore faces a 14-day production duty they cannot satisfy and an evidentiary burden they cannot discharge, with treble damages plus attorney fees and costs at stake. CROSS-STATE NOTE: **no other canvassed state requires supporting EVIDENCE rather than a statement of reasons.** ND 47-16-07.1(3) and NE 76-1416(2) require mandatory itemization; SD 43-32-24 requires an itemized accounting on request within 45 days; KS 58-2550(b) requires written itemized notice; MN 504B.178 subd.3 requires only a statement of specific reasons but places the burden of proof on the landlord. Colorado alone requires the underlying documents. S5a.1: new CO-only row, no shared clause touched, no propagation owed.",
  },
  ...
  },
  {
    ...
    notes: "NEW - LANDLORD_EDUCATION item, added 2026-08-20 per Taylor's direction to track these with the same schema as lease clauses | PART 5 PRIMARY-TEXT READ 2026-08-27 (Taylor supplied full C.R.S. 38-12-503): RESOLVED after two passes at NEEDS_REVIEW. MATERIAL CORRECTION: prior text said relocation is owed 'within 24 hours' full stop. C.R.S. 38-12-503(4)(a)(II) makes it request-triggered - 24 hours runs from the TENANT'S REQUEST, not from notice of the condition, and the duty does not arise unless the tenant asks. Prior text also loosely said 'full kitchen access or cover meal costs'; the statute gives an either/or (fridge-with-freezer AND range/oven, OR the state-employee per diem per tenant every 24 hours). Prior text omitted entirely: bed count, 5/10-mile radius, accessibility, the landlord-pays-only list, that the tenant still owes rent, and the entire 60-day hotel cap and its written-notice + full-deposit-return escape hatch. The 'up to 60 days' figure a secondary source flagged during the re-audit is real but attaches ONLY to hotel rooms under 38-12-503(4)(c), not to comparable dwelling units.",
  },
  {
  ...
  },
  {
    ...
    notes: "NEW (Part 5 read 2026-08-27) - MATERIAL OMISSION. The original CO pass captured only the 24/72-hour commencement windows from Part 5 and none of the surrounding operational duties, several of which are independent breach triggers under 38-12-503(2)(b). Sources: (5)(a)-(c) records; (6)(a)(I)-(II) communication; (12)(b) mold; (14) gas professional; (3)(a)(II) presumptions.",
  },
  {
    ...
    notes: "NEW (Part 5 read 2026-08-27) - 5th confirmed 'void against public policy' standing rule, joining the police-call waiver (38-12-402), immigrant-tenant protections (38-12-1201 et seq.), security-deposit rights (38-12-103(7)), and the wear-and-tear/preexisting-condition fee rule (HB25-1249). Broadest of the five: it covers an entire Part rather than a single right.",
  },
  {
    ...
    notes: "NEW (Part 5 read 2026-08-27). Directly drove the habitability-notice-co correction. Also the first Colorado appellate authority captured in this project - fills part of the case-law gap flagged in the re-audit.",
  },
  {
  ...
  },
  {
    ...
    notes: "CO added (2026-09-03, follow-up to the shared-clause pass). C.R.S. §13-40-123 via the Justia codification: prevailing party recovers damages, reasonable attorney fees, and costs, EXCEPT a residential landlord or tenant who prevails gets no attorney fees unless the rental agreement provides for them. Measure of damages per Behr v. Burge, 940 P.2d 1084 (Colo. App. 1996): 'the reasonable rental value of the premises during the time the other party continued an unlawful detainer.' NO MULTIPLIER FOUND anywhere in C.R.S. Title 13 Article 40. CONFIDENCE: statute text and case annotation both from Justia's codification, not from the Colorado Revisor directly — sound but one source family. The negative (no multiplier) is an absence finding across the article rather than an express statement, so it is the weaker kind of negative. Worth confirming during the next CO pass. NOTE the attorney-fee interaction: §13-40-123's residential carve-out means a fee-shifting clause in the lease is what unlocks fees in a CO holdover action — relevant to edu-fee-shifting-co.",
  },
  {
    id: "edu-holdover-wy",
  ...
  },
  {
    ...
    notes: "CO added (2026-09-03) — RESOLVES the post-writ property question flagged by the eviction-duty screen, and CORRECTS the citation. THE FLAGGED SECTION §38-12-126 DOES NOT EXIST. Taylor confirmed no active section carries that number. The real provision is C.R.S. §13-40-122, in Title 13 Article 40 (Forcible Entry and Detainer), not Title 38. The junk-removal-site source that produced '§38-12-126' was fabricating — same error class as the WY (Hemlane, LeaseWisely) and NE (misattributed $15 payday-loan fee) incidents. Declining to ship a row on that source was correct. Text confirmed consistent across Justia codifications 2016-2024 and FindLaw, plus a county sheriff's own writ-execution requirements document. COLORADO IS THE POLAR OPPOSITE OF MINNESOTA HERE. MN §504B.365 imposes a mandatory signed inventory prepared in the officer's presence, dual-channel notice, a care standard with liability for loss, and two disposal tracks. CO §13-40-122(3) expressly negates every one of those: no storage duty, no inventory duty, no ownership or condition determination, no bailment, and statutory immunity for loss or damage. WY sits between them with simple silence (§1-21-1211(a), no duties stated). Three screened states, three genuinely different architectures — which is itself the answer to whether this area was worth screening. Timing rules from subd. (1)(b): daylight execution only, 10 days after judgment, extended to 30 days where the tenant receives SSI or SSDI. Recorded because it changes a landlord's turnover schedule even though it binds the officer. NOTE the immunity is conditioned on complying with the officer's lawful directions — it is not unconditional. See edu-writ-pet-animal-duties-co for the one place Colorado does impose affirmative duties.",
  },
  {
    ...
    notes: "CO added (2026-09-03) — found while resolving the post-writ property question. THE ONLY AFFIRMATIVE LANDLORD DUTY located in C.R.S. §13-40-122, and it stands in sharp contrast to subd. (3)'s sweeping negation of duties for inanimate property. Confirmed via FindLaw's current codification. THIS IS WHY THE EVICTION-DUTY SCREEN WAS WORTH RUNNING. Colorado's post-writ regime reads at first glance as pure landlord immunity — no storage, no inventory, no bailment, immunity from loss. A screen that stopped at 'CO imposes no post-writ duties' would have recorded the opposite of the truth for the one category where getting it wrong is most likely to produce a headline and an animal-cruelty referral rather than a damages claim. NOT FULLY CHARACTERIZED, FLAGGED: the precise subsection number for the pet-animal provisions was not isolated in the sources reached (FindLaw renders the paragraphs without the enclosing subsection label), and the definition of 'pet animal' — likely cross-referenced to another title — was not read. Confirm both before this row is relied on operationally.",
  },
  {
  ...
  },
  {
    ...
    notes: "C.R.S. § 13-40-107(1) and (4) as amended by HB24-1098, effective 2024-04-19. Primary text 2026-09-06. SURFACED BY THE CROSS-STATE TENANCY-TYPE SCREEN, not previously rowed. The pre-2024 text read 'No notice to quit shall be necessary FROM OR TO a tenant whose term is, by agreement, to end at a time certain.' The current § 13-40-107(4) reads 'No written notice under subsection (1) of this section is necessary FROM A TENANT with a fixed-term tenancy that is, by agreement, to end at a time certain.' The words 'or to' are gone. CONSEQUENCE: the common landlord assumption that a fixed-term lease simply expires with no notice required is no longer correct in Colorado. § 13-40-107(1) expressly covers electing 'to not renew a fixed term tenancy at the end of the fixed term', and subsection (2)'s tiers apply to it. For a tenancy that has run a year or more that is at least 91 days' notice to decline renewal. Edited from the ND re-audit session at Taylor's express direction; Addendum E scoping applies -- notice-period holdings only, not a CO re-audit. § 38-12-1301 et seq. not read, so any interaction with the for-cause regime is unanalysed.",
  },
  {
  ...
  },
  {
    ...
    notes: "NEW (Part 5 read 2026-08-27). Checked the existing tenants-property-insurance clause against this: it requires coverage and proof of coverage but does not require the tenant to claim on it for landlord-responsible repairs, so no clause change is needed. Logged as a standing constraint on landlord conduct and on any future custom insurance language. Note tenants-property-insurance is shared CO;WY - no edit made, so no cross-state impact.",
  },
  {
  ...
  },
  {
    ...
    notes: "NEW - LANDLORD_EDUCATION item, added 2026-08-20 per Taylor's direction to track these with the same schema as lease clauses | AUDIT 2026-08-27 (Opus/high/research re-audit): UPDATED - prior entry described this as unsettled and pending a 2026 legislative fix. That fix passed (HB26-1013), codifying the safe harbor. Status moved NEEDS_REVIEW -> VERIFIED. Confirm the exact effective date of HB26-1013 before relying on it for a lease dated near enactment.",
  },
  {
  ...
  },
  {
    ...
    notes: "NEW (audit 2026-08-27) - MATERIAL OMISSION. Article 12 Part 9 was marked out of scope during the original CO pass on the theory that it is pre-lease only. It is pre-lease, but it constrains landlord conduct in ways a CO landlord using this product needs to know, and it is where the security-deposit installment right conceptually sits. Added as education, not as a lease clause.",
  },
  {
    ...
    notes: "NEW (audit 2026-08-27) - prior research blurred these two provisions. HB25-1240 amended 24-34-502 only; it did not amend 38-12-801(2.5).",
  },
  {
  ...
  },
  {
    ...
    notes: "Added 2026-09-07 (SD re-audit session, cross-state follow-up). C.R.S. 38-12-801(1), with the identity requirement from (2). **GENUINE GAP: no CO row cited or covered subsection (1).** Found by running the L.12 adjacent-provision sweep across all subsections of 38-12-801 rather than stopping at the two amendments the escalation was raised about - both of which turned out to be already covered. The sweep is what produced the finding; the escalation itself was a false positive. CROSS-STATE CONTEXT from the core-obligations canvass: **ND expressly has NO lease-copy duty** (edu-no-lease-copy-duty-nd records that failing to deliver a copy is not a defence a tenant can raise); **MN S504B.115 requires a copy and makes failure a DEFENCE IN EVICTION**; **CO requires it within seven days with an electronic-unless-requested rule.** Three states, three postures, and the duty is the kind of universal obligation L.10 identified as systematically missing from the checklist. The (2) identity requirement is already carried separately by edu-identity-change-notice-co, which covers the one-business-day notice on change of landlord or agent; restated here only because (1) and (2) together are what a landlord must get right at signing. Primary text of the whole of C.R.S. 38-12-801 supplied by Taylor from Colorado Revised Statutes Annotated, current through July 1 2026 of the 2026 Regular Session. Full history: L. 2018 SB 18-010 (part added); L. 2019 HB 19-1170; L. 2021 SB 21-173 ((3) added); L. 2023 HB 23-1120 ((2.5) added) and HB 23-1095 ((4)-(8) added), harmonized on revision; L. 2025 HB 25-1108 ((3.5) added, eff. 2025-09-01) and HB 25-1090 ((3)(a)(VI) amended, eff. 2026-01-01).",
  },
  // Pets
  {
    id: "edu-pet-caps-co",
  ...
  },
  {
    ...
    notes: "NEW 2026-08-27. Added because the federal change is high-profile and a landlord reading headlines could reasonably conclude ESA obligations had ended - they have not in Colorado. Documents the divergence and the independent CADA basis so the next CO review does not have to re-derive it. Source caveat: ESA-certification-industry commentary was discounted as commercially interested; relies on the CADA statutory structure and Colorado practitioner commentary.",
  },
  {
  ...
  },
  {
    ...
    notes: "CO added (eviction-duty screen, 2026-09-03) — MAJOR GAP. Colorado had ZERO rows touching self-help eviction, ouster, lockout, or utility shutoff before this row. C.R.S. §38-12-510, text confirmed via FindLaw's reproduction and the Justia codification. Damages structure: actual damages PLUS the higher of 3x monthly rent or $5,000, plus fees and costs; court may restore possession. Amended by SB 24-094, applying to violations filed on or after 2024-05-03 — so any pre-2024 secondary summary understates the exposure. WHY THIS WAS MISSED, and it is the point of the whole screen: this sits in the eviction/unlawful-removal area the project deprioritized across all states as 'procedural, not clause-relevant.' Colorado is state #1 AND was re-audited on 2026-08-27, and the re-audit did not catch it — because the re-audit inherited the scope boundary rather than questioning it. A deprioritization decision made once in the first state propagated silently through six subsequent states and one re-audit. NOT SHIPPED, FLAGGED FOR VERIFICATION: C.R.S. §38-12-126 reportedly governs a landlord's handling of tenant personal property AFTER a writ is executed ('reasonable efforts', no statutory lien on tenant property, no mandatory storage period unlike voluntary abandonment). Sourced only to a commercial junk-removal site and a case-annotation PDF; NOT primary-verified and therefore NOT written as a row. Read §38-12-126 in full before adding.",
  },
  {
  ...
  },
  {
    ...
    notes: "Added 2026-09-07 (SD re-audit session, cross-state follow-up). C.R.S. 38-12-801(3)(a)(I), with the voiding rule at 38-12-801(3)(b): 'Any provision that is included in a written rental agreement in violation of this subsection (3) is void and unenforceable.' **GENUINE GAP: several CO rows cite 38-12-801(3)(a) generally - nsf-fee-limit-co, default-by-tenant, edu-fee-shifting-co, edu-rubs-uncertainty-co - but none cites or covers (3)(a)(I) specifically.** The library carried (3)(a)(II) fee-shifting, (3)(a)(V) rent-mischaracterisation, (3)(a)(VI) markups and (3)(a)(VII) voucher/utility evictions, and skipped the first item on the list. APPLICABILITY CARVE-OUTS, which do NOT reach this subsection and are recorded to prevent over-reading: 38-12-801(4) disapplies (3)(a)(III)(A),(C),(D),(IV),(V),(VI),(VII) to mobile homes in mobile home parks, and 38-12-801(8) disapplies (3)(a)(III),(IV),(V),(VI),(VII) to owner-occupied duplexes, triplexes and ADUs. **Neither carve-out lists (3)(a)(I) or (3)(a)(II)** - so the eviction-penalty ban and the one-way fee-shifting ban apply to ALL Colorado residential rental agreements including owner-occupied duplexes and mobile homes. That asymmetry is easy to miss and is the reason this row states the carve-outs explicitly. Primary text of the whole of C.R.S. 38-12-801 supplied by Taylor from Colorado Revised Statutes Annotated, current through July 1 2026 of the 2026 Regular Session. Full history: L. 2018 SB 18-010 (part added); L. 2019 HB 19-1170; L. 2021 SB 21-173 ((3) added); L. 2023 HB 23-1120 ((2.5) added) and HB 23-1095 ((4)-(8) added), harmonized on revision; L. 2025 HB 25-1108 ((3.5) added, eff. 2025-09-01) and HB 25-1090 ((3)(a)(VI) amended, eff. 2026-01-01).",
  },
  // Rent & Fees
  {
